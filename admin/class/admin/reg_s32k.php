<?php
	...
	function __get_tournament_parameter_68_69()
	{
		$param = array(
			'mw' => $series_mw,
			'team_num' => 32,
	...
	function get_tournament_parameter_68()
	{
		__get_tournament_parameter_68_69( 'm' );
	}

	function get_tournament_parameter_69()
	{
		__get_tournament_parameter_68_69( 'w' );
	}
	...
	function __output_tournament_68_69_for_excel( $objPage, $series_info, $tournament_data, $entry_list, $mw )
    {
...
//exit;
        ...
        $file_name = $series_info['name'] . '個人トーナメント表_' . $mwstr . '.xlsx';
        ...
        for( $player = 0; $player < $tournament_player_num; $player++ ){
			...
			$name = $tournament_data['data'][0]['player'][$player]['sei'].' '.$tournament_data['data'][0]['player'][$player]['mei'];
			$pref = $tournament_data['data'][0]['player'][$player]['belonging_to_name'];
            if( $player < $tournament_player_num2 ){
                $sheet->setCellValueByColumnAndRow( $col, $row, $index );
                $sheet->setCellValueByColumnAndRow( $col+1, $row, $name );
                $sheet->setCellValueByColumnAndRow( $col+2, $row, '('.$pref.')' );
            } else {
                $sheet->setCellValueByColumnAndRow( $col, $row, $name );
                $sheet->setCellValueByColumnAndRow( $col+1, $row, '('.$pref.')' );
        ...
        $sheet->getColumnDimension(PHPExcel_Cell::stringFromColumnIndex(2))->setWidth(10.0+0.71+0.17);
        ...
        $sheet->getColumnDimension(PHPExcel_Cell::stringFromColumnIndex(4+$match_level*2+1))->setWidth(12.0+0.71+0.17);
        $sheet->getColumnDimension(PHPExcel_Cell::stringFromColumnIndex(4+$match_level*2+2))->setWidth(10.0+0.71+0.17);
...
/*
        ...
        if( $tournament_data['data'][0]['match'][0]['winner'] == 1 ){
            ...
            $sheet->setCellValueByColumnAndRow( 5, $row, '('.$tournament_data['data'][0]['match'][0]['player1_belonging_to_name'].')' );
        } else if( $tournament_data['data'][0]['match'][0]['winner'] == 2 ){
            $sheet->setCellValueByColumnAndRow( 2, $row, $tournament_data['data'][0]['match'][0]['player2_name'] );
            $sheet->setCellValueByColumnAndRow( 5, $row, '('.$tournament_data['data'][0]['match'][0]['player2_belonging_to_name'].')' );
        }
        ...
        if( $tournament_data['data'][0]['match'][$tournament_player_num-1]['winner'] == 1 ){
            ...
            $sheet->setCellValueByColumnAndRow( 5, $row, '('.$tournament_data['data'][0]['match'][$tournament_player_num-1]['player1_belonging_to_name'].')' );
        } else if( $tournament_data['data'][0]['match'][$tournament_player_num-1]['winner'] == 2 ){
            $sheet->setCellValueByColumnAndRow( 2, $row, $tournament_data['data'][0]['match'][$tournament_player_num-1]['player2_name'] );
            $sheet->setCellValueByColumnAndRow( 5, $row, '('.$tournament_data['data'][0]['match'][$tournament_player_num-1]['player2_belonging_to_name'].')' );
        }
        $sheet->getStyle('A'.($row).':F'.$row)->getFont()->setSize(12);
        $sheet->getRowDimension($row)->setRowHeight(16);
        $row++;
        ...
        if( $tournament_data['data'][0]['match'][3]['winner'] == 2 ){
            ...
            $sheet->setCellValueByColumnAndRow( 5, $row, '('.$tournament_data['data'][0]['match'][3]['player1_belonging_to_name'].')' );
            ...
            $sheet->setCellValueByColumnAndRow( 5, $row, '('.$tournament_data['data'][0]['match'][3]['player2_belonging_to_name'].')' );
        }
        $sheet->getStyle('A'.($row).':F'.$row)->getFont()->setSize(12);
        $sheet->getRowDimension($row)->setRowHeight(16);
        $row++;
        ...
        if( $tournament_data['data'][0]['match'][4]['winner'] == 2 ){
            ...
            $sheet->setCellValueByColumnAndRow( 5, $row, '('.$tournament_data['data'][0]['match'][4]['player1_belonging_to_name'].')' );
            ...
            $sheet->setCellValueByColumnAndRow( 5, $row, '('.$tournament_data['data'][0]['match'][4]['player2_belonging_to_name'].')' );
        }
        $sheet->getStyle('A'.($row).':F'.$row)->getFont()->setSize(12);
        $sheet->getRowDimension($row)->setRowHeight(16);
        $row++;
        ...
        if( $tournament_data['data'][0]['match'][5]['winner'] == 2 ){
            ...
            $sheet->setCellValueByColumnAndRow( 5, $row, '('.$tournament_data['data'][0]['match'][5]['player1_belonging_to_name'].')' );
            ...
            $sheet->setCellValueByColumnAndRow( 5, $row, '('.$tournament_data['data'][0]['match'][5]['player2_belonging_to_name'].')' );
        }
        $sheet->getStyle('A'.($row).':F'.$row)->getFont()->setSize(12);
        $sheet->getRowDimension($row)->setRowHeight(16);
        $row++;
        ...
        if( $tournament_data['data'][0]['match'][6]['winner'] == 2 ){
            ...
            $sheet->setCellValueByColumnAndRow( 5, $row, '('.$tournament_data['data'][0]['match'][6]['player1_belonging_to_name'].')' );
            ...
            $sheet->setCellValueByColumnAndRow( 5, $row, '('.$tournament_data['data'][0]['match'][6]['player2_belonging_to_name'].')' );
        }
        $sheet->getStyle('A'.($row).':F'.$row)->getFont()->setSize(12);
        $sheet->getRowDimension($row)->setRowHeight(16);
        $row++;
*/
	...
	function __output_tournament_68_69_for_excel__( $objPage, $series_info, $tournament_data, $entry_list, $mw )
    {
//print_r($tournament_data);
//exit;
	...
	function output_tournament_68_for_excel( $objPage, $series_info, $tournament_data, $entry_list )
	{
		return __output_tournament_68_69_for_excel( $objPage, $series_info, $tournament_data, $entry_list, 'm' );
	}

	function output_tournament_69_for_excel( $objPage, $series_info, $tournament_data, $entry_list )
	{
		return __output_tournament_68_69_for_excel( $objPage, $series_info, $tournament_data, $entry_list, 'w' );
	}
	...
	function output_tournament_match_for_HTML2_68( $objPage, $path, $tournament_list, $entry_list, $mv )
	{
		if( $mv == 'm' ){
			$mvstr = '男子';
		} else {
	...
	function __output_tournament_68_69_for_HTML( $path, $tournament_data, $entry_list, $mv )
	{
//echo '<!-- ';
//print_r($tournament_data);
//echo ' -->';
...
//exit;
	...
	function output_tournament_68_for_HTML( $path, $tournament_data, $entry_list )
	{
		//__output_tournament_68_69_for_HTML( $path, $tournament_data, $entry_list, 'm' );
	...
	function output_tournament_69_for_HTML( $path, $tournament_data, $entry_list )
	{
		//__output_tournament_68_69_for_HTML( $path, $tournament_data, $entry_list, 'w' );
        $objPage = new form_page();
        $objTournament = new form_page_kojin_tournament( $objPage );
        $cssparam = [
			'table_name_rowspan' => 3,
	...
	function __output_entry_data_list_all_1_excel_68_69( $sheet, $series, $series_mw, $start_pos, $series_name )
	{
		$c = new common();
	...
	function output_entry_data_list_all_1_excel_68( $sheet )
	{
		$pos = __output_entry_data_list_all_1_excel68_69( $sheet, 68, 'm', 4, '個人戦男子' );
		__output_entry_data_list_all_1_excel68_69( $sheet, 69, 'w', $pos, '個人戦女子' );
		return true;
	}

	function output_entry_data_list_all_1_excel_69( $sheet )
	{
		$pos = __output_entry_data_list_all_1_excel_68_69( $sheet, 68, 'm', 4, '個人戦男子' );
		__output_entry_data_list_all_1_excel_68_69( $sheet, 69, 'w', $pos, '個人戦女子' );
		return true;
	}

	//--------------------------------------------------------------

	function __output_entry_data_list_all_2_excel_68_69( $sheet, $series, $series_mw, $start_pos, $series_name )
	{
		$c = new common();
	...
	function output_entry_data_list_all_2_excel_68( $sheet )
	{
		$pos = __output_entry_data_list_all_2_excel_68_69( $sheet, 68, 'm', 4, '個人戦男子' );
		__output_entry_data_list_all_2_excel18_69( $sheet, 69, 'w', $pos, '個人戦女子' );
		return false;
	}

	function output_entry_data_list_all_2_excel_69( $sheet )
	{
		$pos = __output_entry_data_list_all_2_excel_68_69( $sheet, 68, 'm', 4, '個人戦男子' );
		__output_entry_data_list_all_2_excel18_69( $sheet, 69, 'w', $pos, '個人戦女子' );
		return false;
	...
	function __get_entry_data_list2_68_69( $series, $series_mw )
	{
		$dbs = db_connect( DATABASE_HOST, DATABASE_USER, DATABASE_PASSWORD, DATABASE_NAME );
		$sql = 'select * from `entry_info`'
			.' where `series`='.$series.' and `year`='.$_SESSION['auth']['year']
	...
	function get_entry_data_list2_68()
	{
		return __get_entry_data_list2_68_69( 68, 'm' );
	}

	function get_entry_data_list2_69()
	{
		return __get_entry_data_list2_68_69( 69, 'w' );
	}

	//--------------------------------------------------------------

	function __get_entry_data_68_69_list_for_PDF( $series, $series_mw )
	{
		$c = new common();
...
//print_r($list);
	...
	function get_entry_data_68_list_for_PDF()
	{
		return __get_entry_data_68_69_list_for_PDF( 18, 'm' );
	}

	function get_entry_data_69_list_for_PDF()
	{
		return __get_entry_data_68_69_list_for_PDF( 19, 'w' );
	}

	//--------------------------------------------------------------

	function __get_entry_data_for_draw_csv_68_69( $list, $series, $series_mw )
	{
		$c = new common();
		$preftbl = $c->get_pref_array();
		$dbs = db_connect( DATABASE_HOST, DATABASE_USER, DATABASE_PASSWORD, DATABASE_NAME );
	...
	function get_entry_data_for_draw_csv_68( $list )
	{
		return array(
			'csv' => __get_entry_data_for_draw_csv_68_69( $list, 18, 'm' ),
			'file' => 'kojin_m.csv'
		);
	}

	function get_entry_data_for_draw_csv_69( $list )
	{
		return array(
			'csv' => __get_entry_data_for_draw_csv_68_69( $list, 19, 'w' ),
			'file' => 'kojin_w.csv'
		);
	}
	...
	function __output_realtime_html_for_one_board_68_69( $place, $place_match_no )
	{
		global $navi_info;
...
*/
	...
	function output_realtime_html_for_one_board_68( $place, $place_match_no )
	{
		return __output_realtime_html_for_one_board_68_69( $place, $place_match_no );
	}

	function output_realtime_html_for_one_board_69( $place, $place_match_no )
	{
		return __output_realtime_html_for_one_board_68_69( $place, $place_match_no );
	}
	...
	function __output_league_62_68_for_HTML( $navi_info, $league_param, $league_list, $entry_list, $mw )
	{
//echo $path;
//print_r($league_list);
		if( $mw == 'm' ){
...
//print_r($league_list);
		...
		//__output_league_62_68_for_HTML( $path, get_league_parameter_62(), $league_list, $entry_list, 'm' );
	}

	function output_league_68_for_HTML( $navi_info, $league_param, $league_list, $entry_list )
	{
        $objPage = new form_page();
        $objPage->output_league_for_HTML( $navi_info, $league_param, $league_list, $entry_list, 'w', false );
		//__output_league_62_68_for_HTML( $path, get_league_parameter_68(), $league_list, $entry_list, 'w' );
	}
	...
	function __output_league_62_68_for_Excel_one( $objPage, $sheet, $col, $row, $league_param, $league_list, $entry_list, $mv )
	{
//print_r($league_list);
		if( $mv == 'm' ){
			$mvstr = '男子';
	...
	function __output_league_62_68_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list, $mw )
	{
//print_r($league_list);
		if( $mw == 'm' ){
			$mwstr = '男子';
...
//echo "1:",$mg_range1,':',$mg_range2,'<br />';
	...
	{
		return __output_league_62_68_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list, 'm' );
	}

	function output_league_68_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list )
	{
		return __output_league_62_68_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list, 'w' );
	}

	//---------------------------------------------------------------
	//
	//---------------------------------------------------------------
	function __output_league_match_for_HTML2_62_68( $objPage, $path, $league_list, $entry_list, $mv )
	{
		if( $mv == 'm' ){
			$mvstr = '男子';
		} else {
	...
	{
		//__output_league_match_for_HTML2_62_68( $objPage, $path, $league_list, $entry_list, 'm' );
        $objPage = new form_page();
	...
	function output_league_match_for_HTML2_68( $navi_info, $league_param, $league_list, $entry_list )
	{
		//__output_league_match_for_HTML2_62_68( $objPage, $path, $league_list, $entry_list, 'w' );
        $objPage = new form_page();
        $objLeague = new form_page_dantai_league( $objPage );
	...
	function __output_league_match_for_excel_62_68( $objPage, $series_info, $league_param, $league_list, $entry_list, $mw )
	{
		if( $mw == 'm' ){
			$mwstr = '男子';
		} else {
...
//exit;
	...
	{
		return __output_league_match_for_excel_62_68( $objPage, $series_info, $league_param, $league_list, $entry_list, 'm' );
	}

	function output_league_match_for_excel_68( $objPage, $series_info, $league_param, $league_list, $entry_list )
	{
		return __output_league_match_for_excel_62_68( $objPage, $series_info, $league_param, $league_list, $entry_list, 'w' );
	}
	...
	function __output_tournament_chart_68_69_for_HTML( $tournament_data, $entry_list )
	{
//echo '<!-- ';
//print_r($tournament_data);
//echo ' -->';
...
//exit;
	...
	function output_tournament_chart_68_for_HTML( $tournament_data, $entry_list )
	{
		return __output_tournament_chart_68_69_for_HTML( $tournament_data, $entry_list );
	}

	function output_tournament_chart_69_for_HTML( $tournament_data, $entry_list )
	{
		return __output_tournament_chart_68_69_for_HTML( $tournament_data, $entry_list );
	}
