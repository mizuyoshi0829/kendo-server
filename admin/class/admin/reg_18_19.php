<?php
	...
	function __get_tournament_parameter_18_19()
	{
		$param = array(
			'mw' => 'w',
			'team_num' => 16,
	...
	function get_tournament_parameter_18()
	{
		__get_tournament_parameter_18_19();
	}

	function get_tournament_parameter_19()
	{
		__get_tournament_parameter_18_19();
	}
	...
	function __output_tournament_18_19_for_excel( $objPage, $path, $tournament_data, $entry_list, $mw )
    {
...
//exit;
        ...
        $file_name = 'H28nanshinKojinTounamentResults_' . $mw . '.xlsx';
        ...
        if( $tournament_data['data']['match'][$tournament_player_num-1]['winner'] == 1 ){
            $sheet->setCellValueByColumnAndRow( 2, $row, $tournament_data['data']['match'][$tournament_player_num-1]['player1_name'] );
            $sheet->setCellValueByColumnAndRow( 5, $row, '('.$tournament_data['data']['match'][$tournament_player_num-1]['player1_school_name_ryaku'].')' );
        } else if( $tournament_data['data']['match'][$tournament_player_num-1]['winner'] == 2 ){
            $sheet->setCellValueByColumnAndRow( 2, $row, $tournament_data['data']['match'][$tournament_player_num-1]['player2_name'] );
            $sheet->setCellValueByColumnAndRow( 5, $row, '('.$tournament_data['data']['match'][$tournament_player_num-1]['player2_school_name_ryaku'].')' );
        }
        $sheet->getStyle('A'.($row).':F'.$row)->getFont()->setSize(12);
        $sheet->getRowDimension($row)->setRowHeight(16);
        $row++;
	...
	function output_tournament_18_for_excel( $objPage, $path, $tournament_data, $entry_list )
	{
		return __output_tournament_18_19_for_excel( $objPage, $path, $tournament_data, $entry_list, 'm' );
	}

	function output_tournament_19_for_excel( $objPage, $path, $tournament_data, $entry_list )
	{
		return __output_tournament_18_19_for_excel( $objPage, $path, $tournament_data, $entry_list, 'w' );
	}
	...
	function output_tournament_match_for_HTML2_18( $objPage, $path, $tournament_list, $entry_list, $mv )
	{
		if( $mv == 'm' ){
			$mvstr = '男子';
		} else {
	...
	function __output_tournament_18_19_for_HTML( $path, $tournament_data, $entry_list, $mv )
	{
//echo '<!-- ';
//print_r($tournament_data);
//echo ' -->';
...
//exit;
	...
	function output_tournament_18_for_HTML( $path, $tournament_data, $entry_list )
	{
		__output_tournament_18_19_for_HTML( $path, $tournament_data, $entry_list, 'm' );
	}

	function output_tournament_19_for_HTML( $path, $tournament_data, $entry_list )
	{
		__output_tournament_18_19_for_HTML( $path, $tournament_data, $entry_list, 'w' );
	}
	...
	function __output_entry_data_list_all_1_excel18_19( $sheet, $series, $series_mw, $start_pos, $series_name )
	{
		$c = new common();
	...
	function output_entry_data_list_all_1_excel18( $sheet )
	{
		$pos = __output_entry_data_list_all_1_excel18_19( $sheet, 18, 'm', 4, '個人戦男子' );
		__output_entry_data_list_all_1_excel18_19( $sheet, 19, 'w', $pos, '個人戦女子' );
		return true;
	}

	function output_entry_data_list_all_1_excel19( $sheet )
	{
		$pos = __output_entry_data_list_all_1_excel18_19( $sheet, 18, 'm', 4, '個人戦男子' );
		__output_entry_data_list_all_1_excel18_19( $sheet, 19, 'w', $pos, '個人戦女子' );
		return true;
	...
	function __output_entry_data_list_all_2_excel18_19( $sheet, $series, $series_mw, $start_pos, $series_name )
	{
		$c = new common();
	...
	function output_entry_data_list_all_2_excel18( $sheet )
	{
		$pos = __output_entry_data_list_all_2_excel18_19( $sheet, 18, 'm', 4, '個人戦男子' );
		__output_entry_data_list_all_2_excel18_19( $sheet, 19, 'w', $pos, '個人戦女子' );
		return false;
	}

	function output_entry_data_list_all_2_excel19( $sheet )
	{
		$pos = __output_entry_data_list_all_2_excel18_19( $sheet, 18, 'm', 4, '個人戦男子' );
		__output_entry_data_list_all_2_excel18_19( $sheet, 19, 'w', $pos, '個人戦女子' );
		return false;
	...
	function __get_entry_data_list2_18_19( $series, $series_mw )
	{
		$dbs = db_connect( DATABASE_HOST, DATABASE_USER, DATABASE_PASSWORD, DATABASE_NAME );
		$sql = 'select * from `entry_info`'
			.' where `series`='.$series.' and `year`='.__REG_SERIES_YEAR__
	...
	function get_entry_data_list2_18()
	{
		return __get_entry_data_list2_18_19( 18, 'm' );
	}

	function get_entry_data_list2_19()
	{
		return __get_entry_data_list2_18_19( 19, 'w' );
	}

	//--------------------------------------------------------------

	function __get_entry_data_18_19_list_for_PDF( $series, $series_mw )
	{
		$c = new common();
...
//print_r($list);
	...
	function get_entry_data_18_list_for_PDF()
	{
		return __get_entry_data_18_19_list_for_PDF( 18, 'm' );
	}

	function get_entry_data_19_list_for_PDF()
	{
		return __get_entry_data_18_19_list_for_PDF( 19, 'w' );
	}

	//--------------------------------------------------------------

	function __get_entry_data_for_draw_csv_18_19( $list, $series, $series_mw )
	{
		$c = new common();
		$preftbl = $c->get_pref_array();
		$dbs = db_connect( DATABASE_HOST, DATABASE_USER, DATABASE_PASSWORD, DATABASE_NAME );
	...
	function get_entry_data_for_draw_csv_18( $list )
	{
		return array(
			'csv' => __get_entry_data_for_draw_csv_18_19( $list, 18, 'm' ),
			'file' => 'kojin_m.csv'
		);
	}

	function get_entry_data_for_draw_csv_19( $list )
	{
		return array(
			'csv' => __get_entry_data_for_draw_csv_18_19( $list, 19, 'w' ),
			'file' => 'kojin_w.csv'
		);
	}
	...
	function __output_realtime_html_for_one_board_18_19( $place, $place_match_no )
	{
		global $navi_info;
...
*/
	...
	function output_realtime_html_for_one_board_18( $place, $place_match_no )
	{
		return __output_realtime_html_for_one_board_18_19( $place, $place_match_no );
	}

	function output_realtime_html_for_one_board_19( $place, $place_match_no )
	{
		return __output_realtime_html_for_one_board_18_19( $place, $place_match_no );
	}
	...
	function __output_tournament_chart_18_19_for_HTML( $tournament_data, $entry_list )
	{
//echo '<!-- ';
//print_r($tournament_data);
//echo ' -->';
...
//exit;
	...
	function output_tournament_chart_18_for_HTML( $tournament_data, $entry_list )
	{
		return __output_tournament_chart_18_19_for_HTML( $tournament_data, $entry_list );
	}

	function output_tournament_chart_19_for_HTML( $tournament_data, $entry_list )
	{
		return __output_tournament_chart_18_19_for_HTML( $tournament_data, $entry_list );
	}
