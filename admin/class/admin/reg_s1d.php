...
//							$html .= $league_list[$league_data]['match'][$match_no_index-1]['hon2'].'-'.$league_list[$league_data]['match'][$match_no_index-1]['win2'];
	...
	function __output_league_20_21_for_HTML( $navi_info, $league_param, $league_list, $entry_list, $mw )
	{
//echo $path;
//print_r($league_list);
		if( $mw == 'm' ){
...
//							$html .= $league_list[$league_data]['match'][$match_no_index-1]['hon2'].'-'.$league_list[$league_data]['match'][$match_no_index-1]['win2'];
	...
	function output_league_20_for_HTML( $navi_info, $league_param, $league_list, $entry_list )
	{
		//__output_league_20_21_for_HTML( $navi_info, $league_param, $league_list, $entry_list, 'm' );
	...
	function output_league_21_for_HTML( $navi_info, $league_param, $league_list, $entry_list )
	{
		//__output_league_20_21_for_HTML( $navi_info, $league_param, $league_list, $entry_list, 'w' );
        $objPage = new form_page();
        $objLeague = new form_page_dantai_league( $objPage );
...
//print_r($league_list);
	...
	function __output_league_20_21_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list, $mw )
	{
//print_r($league_list);
		if( $mw == 'm' ){
			$mwstr = '男子';
		...
		$file_name = $series_info['reg_year'] . 'allnaganoJuniornDantaiLeagueResults_' . $mw . '.xls';
...
//echo "1:",$mg_range1,':',$mg_range2,'<br />';
                ...
                $sheet->getStyle($mg_range1)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
                $sheet->getStyle($mg_range1)->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
                $sheet->getStyle($mg_range1)->getAlignment()->setWrapText(true);
                $sheet->getStyle($mg_range1.':'.$mg_range2)->applyFromArray($border_style);
			}
	...
	function output_league_20_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list )
	{
		return __output_league_20_21_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list, 'm' );
	}

	function output_league_21_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list )
	{
		return __output_league_20_21_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list, 'w' );
	}

	//---------------------------------------------------------------
	//
	//---------------------------------------------------------------
	function __output_league_match_for_HTML2_20_21( $objPage, $navi_info, $league_list, $entry_list, $mw )
	{
		if( $mw == 'm' ){
			$mwstr = '男子';
		} else {
	...
	function output_league_match_for_HTML2_20( $series_info, $league_param, $league_list, $entry_list )
	{
        $objPage = new form_page();
        $objLeague = new form_page_dantai_league( $objPage );
		//__output_league_match_for_HTML2_20_21( $objPage, $series_info, $league_list, $entry_list, 'm' );
        $objLeague->output_league_match_for_HTML2( $series_info, $league_param, $league_list, $entry_list, 'm' );
	}

	function output_league_match_for_HTML2_21( $series_info, $league_param, $league_list, $entry_list )
	{
        $objPage = new form_page();
        $objLeague = new form_page_dantai_league( $objPage );
		//__output_league_match_for_HTML2_20_21( $objPage, $series_info, $league_list, $entry_list, 'w' );
        $objLeague->output_league_match_for_HTML2( $series_info, $league_param, $league_list, $entry_list, 'w' );
	}
	...
	function __output_league_match_for_excel_20_21( $objPage, $series_info, $league_param, $league_list, $entry_list, $mw )
	{
...
//print_r($league_list);
//exit;
		$file_name = $series_info['reg_year'].'allnaganoJuniornDantaiLeagueMatchResults_'.$mw.'.xls';
		$file_path = $series_info['output_path'] . '/' . $file_name;
		...
		for( $league_data = 0; $league_data < count( $league_list ); $league_data++ ){
			...
			for( $match = 0; $match < $league_list[$league_data]['match_num']; $match++ ){
				...
				$row += 2;
				$objMatch->output_one_match_for_excel( $sheet, $col, $row, $series_info, $league_list[$league_data]['match'][$league_list[$league_data]['place_match_info'][$match]], $entry_list, $mw, 46, 46 );
				$row += 4;
			}
		}
		$writer = PHPExcel_IOFactory::createWriter( $excel, 'Excel5' );
	...
	function output_league_match_for_excel_20( $objPage, $series_info, $league_param, $league_list, $entry_list )
	{
		return __output_league_match_for_excel_20_21( $objPage, $series_info, $league_param, $league_list, $entry_list, 'm' );
	}

	function output_league_match_for_excel_21( $objPage, $series_info, $league_param, $league_list, $entry_list )
	{
		return __output_league_match_for_excel_20_21( $objPage, $series_info, $league_param, $league_list, $entry_list, 'w' );
	}
	...
	function __output_tournament_match_20_21_for_excel( $objPage, $series_info, $tournament_param, $tournament_list, $league_data, $entry_list, $mw )
	{
        $objMatch = new form_page_dantai_match( $objPage );
		if( $mw == 'm' ){
			$mwstr = '男子';
		...
		require_once dirname(dirname(dirname(__FILE__))).'/phpExcel/Classes/PHPExcel.php';
		require_once dirname(dirname(dirname(__FILE__))).'/phpExcel/Classes/PHPExcel/IOFactory.php';
		$file_name = $series_info['reg_year'] . 'allnaganoJuniornDantaiTournamentMatchResults_' . $mw . '.xls';
		$file_path = $series_info['output_path'] . '/' . $file_name;
    	...
    	$match_num = intval( $tournament_data['match_num'] );
    	$extra_match_num = intval( $tournament_data['extra_match_num'] );

		$col = 0;
		$row = 4;

		for( $match = 1; $match <= $match_num + $extra_match_num; $match++ ){
            if( $match <= 4 ){
                //if( $mw == 'm' ){
        ...
        //if( $mw == 'm' ){
    		for( $i1 = 1; $i1 <= 4; $i1++ ){
                $objMatch->output_one_match_for_excel( $sheet, $col, $row, $series_info, $tournament_data['match'][$i1+2], $entry_list, $mw, 46, 46 );
                $row += 6;
            }
        //} else {
    	//	for( $i1 = 1; $i1 <= 2; $i1++ ){
        ...
        //}
		for( $i1 = 1; $i1 <= 2; $i1++ ){
            $objMatch->output_one_match_for_excel( $sheet, $col, $row, $series_info, $tournament_data['match'][$i1], $entry_list, $mw, 46, 46 );
            $row += 6;
        }
        $objMatch->output_one_match_for_excel( $sheet, $col, $row, $series_info, $tournament_data['match'][0], $entry_list, $mw, 46, 46 );
        $row += 6;
	...
	function output_tournament_match_20_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list )
	{
		return __output_tournament_match_20_21_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list, 'm' );
	}

	function output_tournament_match_21_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list )
	{
		return __output_tournament_match_20_21_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list, 'w' );
	}
	...
	function __output_tournament_20_21_for_excel( $objPage, $series_info, $tournament_param, $tournament_list, $league_data, $entry_list, $mw )
	{
		if( $mw == 'm' ){
			$mwstr = '男子';
		} else {
...
//exit;
        $file_name = $series_info['reg_year'] . 'allnaganoJuniornDantaiTounamentResults_' . $mw . '.xls';
        $file_path = $series_info['output_path'] . '/' . $file_name;
        $excel = new PHPExcel();
        $excel->setActiveSheetIndex( 0 );        //何番目のシートに有効にするか
        $sheet = $excel->getActiveSheet();    //有効になっているシートを取得
...
//exit;
        ...
        if( $tournament_data['match'][0]['winner'] == 1 ){
            ...
            $sheet->getStyle($col1.($row-4))->getAlignment()->setWrapText(true);
...
*/
	...
	function output_tournament_20_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list )
	{
		return __output_tournament_20_21_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list, 'm' );
	}

	function output_tournament_21_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list )
	{
		return __output_tournament_20_21_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list, 'w' );
	}

	//---------------------------------------------------------------
	//
	//---------------------------------------------------------------
    function __output_tournament_chart_20_21_for_excel( $objPage, $series_info, $tournament_param, $tournament_list, $league_data, $entry_list, $mw )
    {
		if( $mw == 'm' ){
			$mwstr = '男子';
		} else {
...
//exit;
        ...
        $sheet->getStyle( 'B'.($row+4) )->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
        $sheet->getStyle( 'B'.($row+4) )->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
        $sheet->getStyle( 'B'.($row+4) )->getAlignment()->setWrapText(true);
        if( $tournament_data['match'][$tournament_team_num-1]['winner'] == 1 ){
            $sheet->getStyle( 'E'.($row+2) )->applyFromArray( $styleArrayHR );
            $sheet->getStyle( 'E'.($row+6) )->applyFromArray( $styleArrayH );
            $sheet->getStyle( 'E'.($row+2).':E'.($row+3) )->applyFromArray( $styleArrayVR );
	...
	function __output_tournament_chart_20_21_for_excel2( $objPage, $series_info, $tournament_param, $tournament_list, $league_data, $entry_list, $mw )
	{
		if( $mw == 'm' ){
			$mwstr = '男子';
		} else {
	...
	function output_tournament_chart_20_for_excel( $objPage, $series_info, $tournament_param, $tournament_list, $league_data, $entry_list, $mw )
	{
		return __output_tournament_chart_20_21_for_excel( $objPage, $series_info, $tournament_param, $tournament_list, $league_data, $entry_list, 'm' );
	}

	function output_tournament_chart_21_for_excel( $objPage, $series_info, $tournament_param, $tournament_list, $league_data, $entry_list, $mw )
	{
		return __output_tournament_chart_20_21_for_excel( $objPage, $series_info, $tournament_param, $tournament_list, $league_data, $entry_list, 'w' );
	}
	...
	function __output_tournament_match_for_HTML2_20_21( $series_info, $tournament_list, $entry_list, $mw )
	{
		$objPage = new form_page();
		if( $mw == 'm' ){
			$mwstr = '男子';
	...
	function output_tournament_match_for_HTML2_20( $series_info, $tournament_list, $entry_list )
	{
		__output_tournament_match_for_HTML2_20_21( $series_info, $tournament_list, $entry_list, 'm' );
	}

	function output_tournament_match_for_HTML2_21( $series_info, $tournament_list, $entry_list )
	{
		__output_tournament_match_for_HTML2_20_21( $series_info, $tournament_list, $entry_list, 'w' );
	}
...
exit;
	...
	function __output_tournament_20_21_for_HTML( $series_info, $tournament_list, $entry_list, $mw )
	{
//print_r($tournament_data);
//print_r($entry_list);
		if( $mw == 'm' ){
...
//exit;
	...
	function output_tournament_20_for_HTML( $series_info, $tournament_data, $entry_list )
	{
		__output_tournament_20_21_for_HTML( $series_info, $tournament_data, $entry_list, 'm' );
	}

	function output_tournament_21_for_HTML( $series_info, $tournament_data, $entry_list )
	{
		__output_tournament_20_21_for_HTML( $series_info, $tournament_data, $entry_list, 'w' );
	}
	...
	function __output_entry_data_list_all_1_excel20_21( $sheet, $series, $mw, $start_pos, $series_name )
	{
		$c = new common();
		...
		foreach( $list as $lv ){
			...
			for( $player = 1; $player <= 7; $player++ ){
				...
				$sheet->setCellValueByColumnAndRow( $col++, $pos, $fields['dantai_'.$mw.$player.'_sei'] );
				$sheet->setCellValueByColumnAndRow( $col++, $pos, $fields['dantai_'.$mw.$player.'_mei'] );
				if( $fields['player_'.$player.'_add'] == '1' ){
					$sheet->setCellValueByColumnAndRow( $col, $pos, 'あり' );
				}
				$col++;
				$sheet->setCellValueByColumnAndRow( $col++, $pos, $fields['dantai_'.$mw.$player.'_dan'] );
			}
			$pos++;
		}
		db_close( $dbs );
	...
	{
		$pos = __output_entry_data_list_all_1_excel20_21( $sheet, 20, 'm', 4, '団体戦男子' );
		__output_entry_data_list_all_1_excel20_21( $sheet, 21, 'w', $pos+1, '団体戦女子' );
		return false;
	}
