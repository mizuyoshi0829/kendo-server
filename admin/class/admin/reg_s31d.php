<?php
	...
	function __get_league_parameter_62_63( $series_mw )
	{
		$param = array(
			'mw' => $series_mw,
			'team_num' => 3,
	...
	function get_league_parameter_62()
	{
        return __get_league_parameter_62_63( 'm' );
	}

	function get_league_parameter_63()
	{
        return __get_league_parameter_62_63( 'w' );
	}

	function __get_tournament_parameter_62_63()
	{
		$param = array(
			'mw' => $series_mw,
			'team_num' => 8,
	...
	function get_tournament_parameter_62()
	{
		__get_tournament_parameter_62_63( 'm' );
	}

	function get_tournament_parameter_63()
	{
		__get_tournament_parameter_62_63( 'w' );
	}

	function __get_entry_data_62_63_list_for_PDF( $series, $series_mw, $kaisai_rev )
	{
		$c = new common();
...
*/
	...
	function get_entry_data_62_list_for_PDF()
	{
		return __get_entry_data_62_63_list_for_PDF( 16, 'm', 1 );
	}

	function get_entry_data_63_list_for_PDF()
	{
		return __get_entry_data_62_63_list_for_PDF( 17, 'w', 1 );
	}


	function get_entry_data_list_62_sql( $mw )
	{
	...
	function output_league_62_for_HTML_2( $league_list, $entry_list, $mv )
	{
//print_r($league_list);
		if( $mv == 'm' ){
			$mvstr = '男子';
...
//							$html .= $league_list[$league_data]['match'][$match_no_index-1]['hon2'].'-'.$league_list[$league_data]['match'][$match_no_index-1]['win2'];
	...
	function __output_league_62_63_for_HTML( $navi_info, $league_param, $league_list, $entry_list, $mw )
	{
//echo $path;
//print_r($league_list);
		if( $mw == 'm' ){
...
//print_r($league_list);
		...
		//__output_league_62_63_for_HTML( $path, get_league_parameter_62(), $league_list, $entry_list, 'm' );
	}

	function output_league_63_for_HTML( $navi_info, $league_param, $league_list, $entry_list )
	{
        $objPage = new form_page();
        $objPage->output_league_for_HTML( $navi_info, $league_param, $league_list, $entry_list, 'w', false );
		//__output_league_62_63_for_HTML( $path, get_league_parameter_63(), $league_list, $entry_list, 'w' );
	}
	...
	function __output_league_62_63_for_Excel_one( $objPage, $sheet, $col, $row, $league_param, $league_list, $entry_list, $mv )
	{
//print_r($league_list);
		if( $mv == 'm' ){
			$mvstr = '男子';
	...
	function __output_league_62_63_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list, $mw )
	{
//print_r($league_list);
		if( $mw == 'm' ){
			$mwstr = '男子';
...
//echo "1:",$mg_range1,':',$mg_range2,'<br />';
	...
	{
		return __output_league_62_63_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list, 'm' );
	}

	function output_league_63_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list )
	{
		return __output_league_62_63_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list, 'w' );
	}

	//---------------------------------------------------------------
	//
	//---------------------------------------------------------------
	function __output_league_match_for_HTML2_62_63( $objPage, $path, $league_list, $entry_list, $mv )
	{
		if( $mv == 'm' ){
			$mvstr = '男子';
		} else {
	...
	{
		//__output_league_match_for_HTML2_62_63( $objPage, $path, $league_list, $entry_list, 'm' );
        $objPage = new form_page();
	...
	function output_league_match_for_HTML2_63( $navi_info, $league_param, $league_list, $entry_list )
	{
		//__output_league_match_for_HTML2_62_63( $objPage, $path, $league_list, $entry_list, 'w' );
        $objPage = new form_page();
        $objLeague = new form_page_dantai_league( $objPage );
	...
	function __output_league_match_for_excel_62_63( $objPage, $series_info, $league_param, $league_list, $entry_list, $mw )
	{
		if( $mw == 'm' ){
			$mwstr = '男子';
		} else {
...
//exit;
	...
	{
		return __output_league_match_for_excel_62_63( $objPage, $series_info, $league_param, $league_list, $entry_list, 'm' );
	}

	function output_league_match_for_excel_63( $objPage, $series_info, $league_param, $league_list, $entry_list )
	{
		return __output_league_match_for_excel_62_63( $objPage, $series_info, $league_param, $league_list, $entry_list, 'w' );
	}
	...
	function __output_tournament_match_62_63_for_excel( $objPage, $series_info, $tournament_param, $tournament_list, $league_data, $entry_list, $mw )
	{
		if( $mw == 'm' ){
			$mwstr = '男子';
		} else {
	...
	function output_tournament_match_62_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list )
	{
		return __output_tournament_match_62_63_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list, 'm' );
	}

	function output_tournament_match_63_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list )
	{
		return __output_tournament_match_62_63_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list, 'w' );
	}
	...
	function __output_tournament_62_63_for_excel( $objPage, $series_info, $tournament_param, $tournament_list, $league_data, $entry_list, $mw )
	{
		if( $mw == 'm' ){
			$mwstr = '男子';
		} else {
...
//exit;
	...
	function __output_tournament_62_63_for_excel2( $objPage, $series_info, $tournament_param, $tournament_list, $league_data, $entry_list, $mw, $series_m, $series_w )
	{
		if( $mw == 'm' ){
			$mwstr = '男子';
		} else {
...
//exit;
	...
	function output_tournament_chart_62_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list, $mw )
	{
		return __output_tournament_62_63_for_excel2( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list, 'm', 62, 63 );
	}

	function output_tournament_chart_63_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list, $mw )
	{
		return __output_tournament_62_63_for_excel2( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list, 'w', 62, 63 );
	}
	...
	function __output_tournament_chart_62_63_for_excel( $objPage, $series_info, $tournament_list, $league_data, $entry_list, $mw )
	{
		if( $mw == 'm' ){
			$mwstr = '男子';
		} else {
	...
	function output_tournament_chart_62_for_excel_( $objPage, $series_info, $tournament_data, $league_data, $entry_list )
	{
		return __output_tournament_chart_62_63_for_excel( $objPage, $series_info, $tournament_data, $league_data, $entry_list, 'm' );
	}

	function output_tournament_chart_63_for_excel_( $objPage, $series_info, $tournament_data, $league_data, $entry_list )
	{
		return __output_tournament_chart_62_63_for_excel( $objPage, $series_info, $tournament_data, $league_data, $entry_list, 'w' );
	}
	...
	function __output_tournament_match_for_HTML2_62_63( $series_info, $tournament_list, $entry_list, $mw )
	{
		if( $mw == 'm' ){
			$mwstr = '男子';
		} else {
	...
	function output_tournament_match_for_HTML2_62( $series_info, $tournament_list, $entry_list )
	{
		__output_tournament_match_for_HTML2_62_63( $series_info, $tournament_list, $entry_list, 'm' );
	}

	function output_tournament_match_for_HTML2_63( $series_info, $tournament_list, $entry_list )
	{
		__output_tournament_match_for_HTML2_62_63( $series_info, $tournament_list, $entry_list, 'w' );
	}
	...
	function output_tournament_63_for_PDF( $tournament_data, $entry_list, $mv )
	{
	}

	function output_tournament_62_for_PDF( $tournament_data, $entry_list, $mv )
	{
//print_r($tournament_data);
		if( $mv == 'm' ){
			$mvstr = '男子';
...
exit;
	...
	function __output_tournament_62_63_for_HTML( $series_info, $tournament_list, $entry_list, $mv )
	{
//print_r($tournament_data);
//print_r($entry_list);
		if( $mv == 'm' ){
...
//exit;
	...
	function output_tournament_62_for_HTML( $series_info, $tournament_data, $entry_list )
	{
		__output_tournament_62_63_for_HTML( $series_info, $tournament_data, $entry_list, 'm' );
	}

	function output_tournament_63_for_HTML( $series_info, $tournament_data, $entry_list )
	{
		__output_tournament_62_63_for_HTML( $series_info, $tournament_data, $entry_list, 'w' );
	}
	...
	function __output_entry_data_list_all_1_excel62_63( $sheet, $series, $mv, $start_pos, $series_name, $kaisai_rev )
	{
		$c = new common();
	...
	function output_entry_data_list_all_1_excel62( $sheet )
	{
		__output_entry_data_list_all_1_excel62_63( $sheet, 16, 'm', 4, '団体戦男子', 1 );
		__output_entry_data_list_all_1_excel16_63( $sheet, 17, 'w', 4+48, '団体戦女子', 1 );
		return false;
	}

	function output_entry_data_list_all_1_excel63( $sheet )
	{
		__output_entry_data_list_all_1_excel62_63( $sheet, 16, 'm', 4, '団体戦男子', 1 );
		__output_entry_data_list_all_1_excel62_63( $sheet, 17, 'w', 4+48, '団体戦女子', 1 );
		return false;
	}

	//--------------------------------------------------------------

	function __get_entry_data_list2_62_63( $series )
	{
		$dbs = db_connect( DATABASE_HOST, DATABASE_USER, DATABASE_PASSWORD, DATABASE_NAME );
		$sql = 'select * from `entry_info`'
			.' where `series`='.$series.' and `year`='.$_SESSION['auth']['year']
	...
	function get_entry_data_list2_62()
	{
		return __get_entry_data_list2_62_63( 62 );
	}

	function get_entry_data_list2_63()
	{
		return __get_entry_data_list2_62_63( 63 );
	}

	//--------------------------------------------------------------

	function __get_entry_data_for_draw_csv_62_63( $list, $series )
	{
		$c = new common();
	...
	function get_entry_data_for_draw_csv_62( $list )
	{
		return array(
			'csv' => __get_entry_data_for_draw_csv_62_63( $list, 16 ),
			'file' => 'dantai_m.csv'
		);
	}

	function get_entry_data_for_draw_csv_63( $list )
	{
		return array(
			'csv' => __get_entry_data_for_draw_csv_62_63( $list, 17 ),
			'file' => 'dantai_w.csv'
		);
	}
	...
	function __output_realtime_html_for_one_board_62_63( $place, $place_match_no )
	{
		global $navi_info;
...
*/
	...
	function output_realtime_html_for_one_board_62( $place, $place_match_no )
	{
		//return __output_realtime_html_for_one_board_62_63( $place, $place_match_no );
		return '';
	}

	function output_realtime_html_for_one_board_63( $place, $place_match_no )
	{
		//return __output_realtime_html_for_one_board_62_63( $place, $place_match_no );
		return '';
	}
