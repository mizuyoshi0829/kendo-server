<?php
	...
	function __get_tournament_parameter_30_31()
	{
		$param = array(
			'mw' => $series_mw,
			'team_num' => 32,
	...
	function get_tournament_parameter_30()
	{
		__get_tournament_parameter_30_31( 'm' );
	}

	function get_tournament_parameter_31()
	{
		__get_tournament_parameter_30_31( 'w' );
	}
	...
	function __output_tournament_30_31_for_excel( $objPage, $series_info, $tournament_data, $entry_list, $mw )
    {
...
//exit;
	...
	function output_tournament_30_for_excel( $objPage, $series_info, $tournament_data, $entry_list )
	{
		return __output_tournament_30_31_for_excel( $objPage, $series_info, $tournament_data, $entry_list, 'm' );
	}

	function output_tournament_31_for_excel( $objPage, $series_info, $tournament_data, $entry_list )
	{
		return __output_tournament_30_31_for_excel( $objPage, $series_info, $tournament_data, $entry_list, 'w' );
	}
	...
	function output_tournament_match_for_HTML2_30( $objPage, $path, $tournament_list, $entry_list, $mv )
	{
		if( $mv == 'm' ){
			$mvstr = '男子';
		} else {
	...
	function __output_tournament_30_31_for_HTML( $path, $tournament_data, $entry_list, $mv )
	{
//echo '<!-- ';
//print_r($tournament_data);
//echo ' -->';
...
//exit;
	...
	function output_tournament_30_for_HTML( $path, $tournament_data, $entry_list )
	{
		//__output_tournament_30_31_for_HTML( $path, $tournament_data, $entry_list, 'm' );
	...
	function output_tournament_31_for_HTML( $path, $tournament_data, $entry_list )
	{
		//__output_tournament_30_31_for_HTML( $path, $tournament_data, $entry_list, 'w' );
        $objPage = new form_page();
        $objTournament = new form_page_kojin_tournament( $objPage );
	...
	function __output_entry_data_list_all_1_excel_30_31( $sheet, $series, $series_mw, $start_pos, $series_name )
	{
		$c = new common();
	...
	function output_entry_data_list_all_1_excel_30( $sheet )
	{
		$pos = __output_entry_data_list_all_1_excel30_31( $sheet, 30, 'm', 4, '個人戦男子' );
		__output_entry_data_list_all_1_excel30_31( $sheet, 31, 'w', $pos, '個人戦女子' );
		return true;
	}

	function output_entry_data_list_all_1_excel_31( $sheet )
	{
		$pos = __output_entry_data_list_all_1_excel_30_31( $sheet, 30, 'm', 4, '個人戦男子' );
		__output_entry_data_list_all_1_excel_30_31( $sheet, 31, 'w', $pos, '個人戦女子' );
		return true;
	}

	//--------------------------------------------------------------

	function __output_entry_data_list_all_2_excel_30_31( $sheet, $series, $series_mw, $start_pos, $series_name )
	{
		$c = new common();
	...
	function output_entry_data_list_all_2_excel_30( $sheet )
	{
		$pos = __output_entry_data_list_all_2_excel_30_31( $sheet, 30, 'm', 4, '個人戦男子' );
		__output_entry_data_list_all_2_excel18_31( $sheet, 31, 'w', $pos, '個人戦女子' );
		return false;
	}

	function output_entry_data_list_all_2_excel_31( $sheet )
	{
		$pos = __output_entry_data_list_all_2_excel_30_31( $sheet, 30, 'm', 4, '個人戦男子' );
		__output_entry_data_list_all_2_excel18_31( $sheet, 31, 'w', $pos, '個人戦女子' );
		return false;
	...
	function __get_entry_data_list2_30_31( $series, $series_mw )
	{
		$dbs = db_connect( DATABASE_HOST, DATABASE_USER, DATABASE_PASSWORD, DATABASE_NAME );
		$sql = 'select * from `entry_info`'
			.' where `series`='.$series.' and `year`='.$_SESSION['auth']['year']
	...
	function get_entry_data_list2_30()
	{
		return __get_entry_data_list2_30_31( 30, 'm' );
	}

	function get_entry_data_list2_31()
	{
		return __get_entry_data_list2_30_31( 31, 'w' );
	}

	//--------------------------------------------------------------

	function __get_entry_data_30_31_list_for_PDF( $series, $series_mw )
	{
		$c = new common();
...
//print_r($list);
	...
	function get_entry_data_30_list_for_PDF()
	{
		return __get_entry_data_30_31_list_for_PDF( 18, 'm' );
	}

	function get_entry_data_31_list_for_PDF()
	{
		return __get_entry_data_30_31_list_for_PDF( 19, 'w' );
	}

	//--------------------------------------------------------------

	function __get_entry_data_for_draw_csv_30_31( $list, $series, $series_mw )
	{
		$c = new common();
		$preftbl = $c->get_pref_array();
		$dbs = db_connect( DATABASE_HOST, DATABASE_USER, DATABASE_PASSWORD, DATABASE_NAME );
	...
	function get_entry_data_for_draw_csv_30( $list )
	{
		return array(
			'csv' => __get_entry_data_for_draw_csv_30_31( $list, 18, 'm' ),
			'file' => 'kojin_m.csv'
		);
	}

	function get_entry_data_for_draw_csv_31( $list )
	{
		return array(
			'csv' => __get_entry_data_for_draw_csv_30_31( $list, 19, 'w' ),
			'file' => 'kojin_w.csv'
		);
	}
	...
	function __output_realtime_html_for_one_board_30_31( $place, $place_match_no )
	{
		global $navi_info;
...
*/
	...
	function output_realtime_html_for_one_board_30( $place, $place_match_no )
	{
		return __output_realtime_html_for_one_board_30_31( $place, $place_match_no );
	}

	function output_realtime_html_for_one_board_31( $place, $place_match_no )
	{
		return __output_realtime_html_for_one_board_30_31( $place, $place_match_no );
	}
	...
	function __output_tournament_chart_30_31_for_HTML( $tournament_data, $entry_list )
	{
//echo '<!-- ';
//print_r($tournament_data);
//echo ' -->';
...
//exit;
	...
	function output_tournament_chart_30_for_HTML( $tournament_data, $entry_list )
	{
		return __output_tournament_chart_30_31_for_HTML( $tournament_data, $entry_list );
	}

	function output_tournament_chart_31_for_HTML( $tournament_data, $entry_list )
	{
		return __output_tournament_chart_30_31_for_HTML( $tournament_data, $entry_list );
	}
