<?php
	...
	function get_league_parameter_6()
	{
		$param = array(
			'mw' => 'w',
			'team_num' => 3,
	...
	function get_tournament_parameter_6()
	{
		$param = array(
			'mw' => 'w',
			'team_num' => 16,
	...
	function init_entry_post_data_from_def_6_shumoku_dantai( &$data, $def, $add1, $add2 )
	{
	...
	function get_entry_post_data_from_def_6_shumoku_dantai( $def, $add1, $add2 )
	{
	...
	function get_entry_db_data_from_def_6_shumoku_dantai( $data, $list, $def, $add1, $add2 )
	{
	...
	function update_entry_data_6_shumoku_dantai( $def, $dbs )
	{
		$data = array(
	...
	function is_entry_data_6_join_shumoku_dantai( $data )
	{
	...
	function get_entry_data_6_list_for_PDF( $pref_array, $grade_junior_array )
	{
...
//exit;
	...
	function get_entry_data_list_6_sql( $mw )
	{
	...
	function output_league_6_for_HTML_2( $league_list, $entry_list, $mv )
	{
//print_r($league_list);
		if( $mv == 'm' ){
			$mvstr = '男子';
...
//							$html .= $league_list[$league_data]['match'][$match_no_index-1]['hon2'].'-'.$league_list[$league_data]['match'][$match_no_index-1]['win2'];
	...
	function output_league_6_for_HTML( $path, $league_list, $entry_list, $mv )
	{
//print_r($league_list);
		if( $mv == 'm' ){
			$mvstr = '男子';
		...
		$footer = '     <h2 align="left" class="tx-h1"><a href="index_w.html">←戻る</a></h2>'."\n";
		$footer .= '    <br />'."\n";
		$footer .= '    <br />'."\n";
		$footer .= '    </div>'."\n";
...
//							$html .= $league_list[$league_data]['match'][$match_no_index-1]['hon2'].'-'.$league_list[$league_data]['match'][$match_no_index-1]['win2'];
	...
	function output_league_6_for_Excel( $objPage, $path, $league_list, $entry_list, $mv )
	{
//print_r($league_list);
		if( $mv == 'm' ){
			$mvstr = '男子';
	...
	function output_league_match_for_HTML2_6( $objPage, $path, $league_list, $entry_list, $mv )
	{
		if( $mv == 'm' ){
			$mvstr = '男子';
		} else {
	...
	function output_league_match_for_excel_6( $objPage, $path, $league_list, $entry_list, $mv )
	{
		if( $mv == 'm' ){
			$mvstr = '男子';
		} else {
	...
	function output_tournament_6_for_excel( $objPage, $path, $tournament_data, $entry_list, $mv )
	{
		if( $mv == 'm' ){
			$mvstr = '男子';
		} else {
	...
	function output_tournament_match_for_HTML2_6( $objPage, $path, $tournament_list, $entry_list, $mv )
	{
		if( $mv == 'm' ){
			$mvstr = '男子';
		} else {
	...
	function output_tournament_6_for_PDF( $tournament_data, $entry_list, $mv )
	{
...
exit;
	...
	function output_tournament_6_for_HTML( $tournament_data, $entry_list, $mv )
	{
//print_r($tournament_data);
		if( $mv == 'm' ){
			$mvstr = '男子';
