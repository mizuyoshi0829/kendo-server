<?php
	...
	function __get_tournament_parameter_26_27()
	{
		$param = array(
			'mw' => $series_mw,
			'team_num' => 32,
	...
	function get_tournament_parameter_26()
	{
		__get_tournament_parameter_26_27( 'm' );
	}

	function get_tournament_parameter_27()
	{
		__get_tournament_parameter_26_27( 'w' );
	}
	...
	function __output_tournament_26_27_for_excel( $objPage, $path, $tournament_data, $entry_list, $mw )
    {
...
//exit;
        ...
        $file_name = 'H30nanshinJuniorKojinTounamentResults_' . $mw . '.xlsx';
	...
	function output_tournament_26_for_excel( $objPage, $path, $tournament_data, $entry_list )
	{
		return __output_tournament_26_27_for_excel( $objPage, $path, $tournament_data, $entry_list, 'm' );
	}

	function output_tournament_27_for_excel( $objPage, $path, $tournament_data, $entry_list )
	{
		return __output_tournament_26_27_for_excel( $objPage, $path, $tournament_data, $entry_list, 'w' );
	}
	...
	function output_tournament_match_for_HTML2_26( $objPage, $path, $tournament_list, $entry_list, $mv )
	{
		if( $mv == 'm' ){
			$mvstr = '男子';
		} else {
	...
	function __output_tournament_26_27_for_HTML( $path, $tournament_data, $entry_list, $mv )
	{
//echo '<!-- ';
//print_r($tournament_data);
//echo ' -->';
...
//exit;
	...
	function output_tournament_26_for_HTML( $path, $tournament_data, $entry_list )
	{
		__output_tournament_26_27_for_HTML( $path, $tournament_data, $entry_list, 'm' );
	}

	function output_tournament_27_for_HTML( $path, $tournament_data, $entry_list )
	{
		__output_tournament_26_27_for_HTML( $path, $tournament_data, $entry_list, 'w' );
	}
	...
	function __output_entry_data_list_all_1_excel_26_27( $sheet, $series, $series_mw, $start_pos, $series_name )
	{
		$c = new common();
	...
	function output_entry_data_list_all_1_excel_26( $sheet )
	{
		$pos = __output_entry_data_list_all_1_excel26_27( $sheet, 26, 'm', 4, '個人戦男子' );
		__output_entry_data_list_all_1_excel26_27( $sheet, 27, 'w', $pos, '個人戦女子' );
		return true;
	}

	function output_entry_data_list_all_1_excel_27( $sheet )
	{
		$pos = __output_entry_data_list_all_1_excel_26_27( $sheet, 26, 'm', 4, '個人戦男子' );
		__output_entry_data_list_all_1_excel_26_27( $sheet, 27, 'w', $pos, '個人戦女子' );
		return true;
	}

	//--------------------------------------------------------------

	function __output_entry_data_list_all_2_excel_26_27( $sheet, $series, $series_mw, $start_pos, $series_name )
	{
		$c = new common();
	...
	function output_entry_data_list_all_2_excel_26( $sheet )
	{
		$pos = __output_entry_data_list_all_2_excel_26_27( $sheet, 26, 'm', 4, '個人戦男子' );
		__output_entry_data_list_all_2_excel18_27( $sheet, 27, 'w', $pos, '個人戦女子' );
		return false;
	}

	function output_entry_data_list_all_2_excel_27( $sheet )
	{
		$pos = __output_entry_data_list_all_2_excel_26_27( $sheet, 26, 'm', 4, '個人戦男子' );
		__output_entry_data_list_all_2_excel18_27( $sheet, 27, 'w', $pos, '個人戦女子' );
		return false;
	...
	function __get_entry_data_list2_26_27( $series, $series_mw )
	{
		$dbs = db_connect( DATABASE_HOST, DATABASE_USER, DATABASE_PASSWORD, DATABASE_NAME );
		$sql = 'select * from `entry_info`'
			.' where `series`='.$series.' and `year`='.$_SESSION['auth']['year']
	...
	function get_entry_data_list2_26()
	{
		return __get_entry_data_list2_26_27( 26, 'm' );
	}

	function get_entry_data_list2_27()
	{
		return __get_entry_data_list2_26_27( 27, 'w' );
	}

	//--------------------------------------------------------------

	function __get_entry_data_26_27_list_for_PDF( $series, $series_mw )
	{
		$c = new common();
...
//print_r($list);
	...
	function get_entry_data_26_list_for_PDF()
	{
		return __get_entry_data_26_27_list_for_PDF( 18, 'm' );
	}

	function get_entry_data_27_list_for_PDF()
	{
		return __get_entry_data_26_27_list_for_PDF( 19, 'w' );
	}

	//--------------------------------------------------------------

	function __get_entry_data_for_draw_csv_26_27( $list, $series, $series_mw )
	{
		$c = new common();
		$preftbl = $c->get_pref_array();
		$dbs = db_connect( DATABASE_HOST, DATABASE_USER, DATABASE_PASSWORD, DATABASE_NAME );
	...
	function get_entry_data_for_draw_csv_26( $list )
	{
		return array(
			'csv' => __get_entry_data_for_draw_csv_26_27( $list, 18, 'm' ),
			'file' => 'kojin_m.csv'
		);
	}

	function get_entry_data_for_draw_csv_27( $list )
	{
		return array(
			'csv' => __get_entry_data_for_draw_csv_26_27( $list, 19, 'w' ),
			'file' => 'kojin_w.csv'
		);
	}
	...
	function __output_realtime_html_for_one_board_26_27( $place, $place_match_no )
	{
		global $navi_info;
...
*/
	...
	function output_realtime_html_for_one_board_26( $place, $place_match_no )
	{
		return __output_realtime_html_for_one_board_26_27( $place, $place_match_no );
	}

	function output_realtime_html_for_one_board_27( $place, $place_match_no )
	{
		return __output_realtime_html_for_one_board_26_27( $place, $place_match_no );
	}
	...
	function __output_tournament_chart_26_27_for_HTML( $tournament_data, $entry_list )
	{
//echo '<!-- ';
//print_r($tournament_data);
//echo ' -->';
...
//exit;
	...
	function output_tournament_chart_26_for_HTML( $tournament_data, $entry_list )
	{
		return __output_tournament_chart_26_27_for_HTML( $tournament_data, $entry_list );
	}

	function output_tournament_chart_27_for_HTML( $tournament_data, $entry_list )
	{
		return __output_tournament_chart_26_27_for_HTML( $tournament_data, $entry_list );
	}
