<?php
	...
	function get_tournament_parameter_48()
	{
		$param = array(
			'mw' => 'w',
			'team_num' => 64,
	...
	function output_entry_data_list_all_1_excel48( $sheet )
	{
        $objPage = new form_page();
        $objPage->output_entry_data_list_all_1_excel( $sheet, 48, '', 2, '' );
        return false;
	}

	//--------------------------------------------------------------

	function output_entry_data_list_all_2_excel48( $sheet, $series, $series_mw, $start_pos, $series_name )
	{
		$c = new common();
	...
	function get_entry_data_list2_48( $series=48 )
	{
		$c = new common();
	...
	function get_entry_data_48_list_for_PDF( $series, $series_mw )
	{
		$c = new common();
...
//print_r($list);
	...
	function get_entry_data_for_draw_csv_48( $list, $series, $series_mw )
	{
		$c = new common();
		$preftbl = $c->get_pref_array();
		$dbs = db_connect( DATABASE_HOST, DATABASE_USER, DATABASE_PASSWORD, DATABASE_NAME );
