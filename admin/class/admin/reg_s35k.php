<?php
	...
	function __get_tournament_parameter_76_77( $series_mw )
	{
		$param = array(
			'mw' => $series_mw,
			'team_num' => 32,
	...
	function get_tournament_parameter_76()
	{
		__get_tournament_parameter_76_77( 'm' );
	}

	function get_tournament_parameter_77()
	{
		__get_tournament_parameter_76_77( 'w' );
	}
	...
	function __output_tournament_76_77_for_excel( $objPage, $series_info, $tournament_data, $entry_list, $mw )
    {
...
*/
	...
	function __output_tournament_76_77_for_excel__( $objPage, $series_info, $tournament_data, $entry_list, $mw )
    {
//print_r($tournament_data);
//exit;
	...
	function output_tournament_76_for_excel( $objPage, $series_info, $tournament_data, $entry_list )
	{
		return __output_tournament_76_77_for_excel( $objPage, $series_info, $tournament_data, $entry_list, 'm' );
	}

	function output_tournament_77_for_excel( $objPage, $series_info, $tournament_data, $entry_list )
	{
		return __output_tournament_76_77_for_excel( $objPage, $series_info, $tournament_data, $entry_list, 'w' );
	}
	...
	function output_tournament_match_for_HTML2_76( $objPage, $path, $tournament_list, $entry_list, $mv )
	{
		if( $mv == 'm' ){
			$mvstr = '男子';
		} else {
	...
	function __output_tournament_76_77_for_HTML( $path, $tournament_data, $entry_list, $mv )
	{
//echo '<!-- ';
//print_r($tournament_data);
//echo ' -->';
...
//exit;
	...
	function output_tournament_76_for_HTML( $path, $tournament_data, $entry_list )
	{
	...
	function output_tournament_77_for_HTML( $path, $tournament_data, $entry_list )
	{
		//__output_tournament_76_77_for_HTML( $path, $tournament_data, $entry_list, 'w' );
        $objPage = new form_page();
        $objTournament = new form_page_kojin_tournament( $objPage );
        $cssparam = [
			'table_name_rowspan' => 3,
	...
	function __output_entry_data_list_all_1_excel_76_77( $sheet, $series, $series_mw, $start_pos, $series_name )
	{
		$c = new common();
	...
	function output_entry_data_list_all_1_excel_76( $sheet )
	{
		$pos = __output_entry_data_list_all_1_excel76_77( $sheet, 76, 'm', 4, '個人戦男子' );
		__output_entry_data_list_all_1_excel76_77( $sheet, 77, 'w', $pos, '個人戦女子' );
		return true;
	}

	function output_entry_data_list_all_1_excel_77( $sheet )
	{
		$pos = __output_entry_data_list_all_1_excel_76_77( $sheet, 76, 'm', 4, '個人戦男子' );
		__output_entry_data_list_all_1_excel_76_77( $sheet, 77, 'w', $pos, '個人戦女子' );
		return true;
	}

	//--------------------------------------------------------------

	function __output_entry_data_list_all_2_excel_76_77( $sheet, $series, $series_mw, $start_pos, $series_name )
	{
		$c = new common();
	...
	function output_entry_data_list_all_2_excel_76( $sheet )
	{
		$pos = __output_entry_data_list_all_2_excel_76_77( $sheet, 76, 'm', 4, '個人戦男子' );
		__output_entry_data_list_all_2_excel18_77( $sheet, 77, 'w', $pos, '個人戦女子' );
		return false;
	}

	function output_entry_data_list_all_2_excel_77( $sheet )
	{
		$pos = __output_entry_data_list_all_2_excel_76_77( $sheet, 76, 'm', 4, '個人戦男子' );
		__output_entry_data_list_all_2_excel18_77( $sheet, 77, 'w', $pos, '個人戦女子' );
		return false;
	...
	function __get_entry_data_list2_76_77( $series, $series_mw )
	{
		$dbs = db_connect( DATABASE_HOST, DATABASE_USER, DATABASE_PASSWORD, DATABASE_NAME );
		$sql = 'select * from `entry_info`'
			.' where `series`='.$series.' and `year`='.$_SESSION['auth']['year']
	...
	function get_entry_data_list2_76()
	{
		return __get_entry_data_list2_76_77( 76, 'm' );
	}

	function get_entry_data_list2_77()
	{
		return __get_entry_data_list2_76_77( 77, 'w' );
	}

	//--------------------------------------------------------------

	function __get_entry_data_76_77_list_for_PDF( $series, $series_mw )
	{
		$c = new common();
...
//print_r($list);
	...
	function get_entry_data_76_list_for_PDF()
	{
		return __get_entry_data_76_77_list_for_PDF( 18, 'm' );
	}

	function get_entry_data_77_list_for_PDF()
	{
		return __get_entry_data_76_77_list_for_PDF( 19, 'w' );
	}

	//--------------------------------------------------------------

	function __get_entry_data_for_draw_csv_76_77( $list, $series, $series_mw )
	{
		$c = new common();
		$preftbl = $c->get_pref_array();
		$dbs = db_connect( DATABASE_HOST, DATABASE_USER, DATABASE_PASSWORD, DATABASE_NAME );
	...
	function get_entry_data_for_draw_csv_76( $list )
	{
		return array(
			'csv' => __get_entry_data_for_draw_csv_76_77( $list, 18, 'm' ),
			'file' => 'kojin_m.csv'
		);
	}

	function get_entry_data_for_draw_csv_77( $list )
	{
		return array(
			'csv' => __get_entry_data_for_draw_csv_76_77( $list, 19, 'w' ),
			'file' => 'kojin_w.csv'
		);
	}
	...
	function __output_realtime_html_for_one_board_76_77( $place, $place_match_no )
	{
		global $navi_info;
...
*/
	...
	function output_realtime_html_for_one_board_76( $place, $place_match_no )
	{
		return __output_realtime_html_for_one_board_76_77( $place, $place_match_no );
	}

	function output_realtime_html_for_one_board_77( $place, $place_match_no )
	{
		return __output_realtime_html_for_one_board_76_77( $place, $place_match_no );
	}
	...
	function __output_league_62_76_for_HTML( $navi_info, $league_param, $league_list, $entry_list, $mw )
	{
//echo $path;
//print_r($league_list);
		if( $mw == 'm' ){
...
//print_r($league_list);
		...
		//__output_league_62_76_for_HTML( $path, get_league_parameter_62(), $league_list, $entry_list, 'm' );
	}

	function output_league_76_for_HTML( $navi_info, $league_param, $league_list, $entry_list )
	{
        $objPage = new form_page();
        $objPage->output_league_for_HTML( $navi_info, $league_param, $league_list, $entry_list, 'w', false );
		//__output_league_62_76_for_HTML( $path, get_league_parameter_76(), $league_list, $entry_list, 'w' );
	}
	...
	function __output_league_62_76_for_Excel_one( $objPage, $sheet, $col, $row, $league_param, $league_list, $entry_list, $mv )
	{
//print_r($league_list);
		if( $mv == 'm' ){
			$mvstr = '男子';
	...
	function __output_league_62_76_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list, $mw )
	{
//print_r($league_list);
		if( $mw == 'm' ){
			$mwstr = '男子';
...
//echo "1:",$mg_range1,':',$mg_range2,'<br />';
	...
	{
		return __output_league_62_76_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list, 'm' );
	}

	function output_league_76_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list )
	{
		return __output_league_62_76_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list, 'w' );
	}

	//---------------------------------------------------------------
	//
	//---------------------------------------------------------------
	function __output_league_match_for_HTML2_62_76( $objPage, $path, $league_list, $entry_list, $mv )
	{
		if( $mv == 'm' ){
			$mvstr = '男子';
		} else {
	...
	{
		//__output_league_match_for_HTML2_62_76( $objPage, $path, $league_list, $entry_list, 'm' );
        $objPage = new form_page();
	...
	function output_league_match_for_HTML2_76( $navi_info, $league_param, $league_list, $entry_list )
	{
		//__output_league_match_for_HTML2_62_76( $objPage, $path, $league_list, $entry_list, 'w' );
        $objPage = new form_page();
        $objLeague = new form_page_dantai_league( $objPage );
	...
	function __output_league_match_for_excel_62_76( $objPage, $series_info, $league_param, $league_list, $entry_list, $mw )
	{
		if( $mw == 'm' ){
			$mwstr = '男子';
		} else {
...
//exit;
	...
	{
		return __output_league_match_for_excel_62_76( $objPage, $series_info, $league_param, $league_list, $entry_list, 'm' );
	}

	function output_league_match_for_excel_76( $objPage, $series_info, $league_param, $league_list, $entry_list )
	{
		return __output_league_match_for_excel_62_76( $objPage, $series_info, $league_param, $league_list, $entry_list, 'w' );
	}
	...
	function __output_tournament_chart_76_77_for_HTML( $tournament_data, $entry_list )
	{
//echo '<!-- ';
//print_r($tournament_data);
//echo ' -->';
...
//exit;
	...
	function output_tournament_chart_76_for_HTML( $tournament_data, $entry_list )
	{
		return __output_tournament_chart_76_77_for_HTML( $tournament_data, $entry_list );
	}

	function output_tournament_chart_77_for_HTML( $tournament_data, $entry_list )
	{
		return __output_tournament_chart_76_77_for_HTML( $tournament_data, $entry_list );
	}
