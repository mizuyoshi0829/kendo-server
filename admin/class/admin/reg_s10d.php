<?php
	...
	function __get_league_parameter_37_38( $series_mw )
	{
		$param = array(
			'mw' => $series_mw,
			'team_num' => 3,
	...
	function get_league_parameter_37()
	{
        return __get_league_parameter_37_38( 'm' );
	}

	function get_league_parameter_38()
	{
        return __get_league_parameter_37_38( 'w' );
	}

	function __get_tournament_parameter_37_38()
	{
		$param = array(
			'mw' => $series_mw,
			'team_num' => 8,
	...
	function get_tournament_parameter_37()
	{
		__get_tournament_parameter_37_38( 'm' );
	}

	function get_tournament_parameter_38()
	{
		__get_tournament_parameter_37_38( 'w' );
	}

	function __get_entry_data_37_38_list_for_PDF( $series, $series_mw, $kaisai_rev )
	{
		$c = new common();
...
*/
	...
	function get_entry_data_37_list_for_PDF()
	{
		return __get_entry_data_37_38_list_for_PDF( 16, 'm', 1 );
	}

	function get_entry_data_38_list_for_PDF()
	{
		return __get_entry_data_37_38_list_for_PDF( 17, 'w', 1 );
	}


	function get_entry_data_list_37_sql( $mw )
	{
	...
	function output_league_37_for_HTML_2( $league_list, $entry_list, $mv )
	{
//print_r($league_list);
		if( $mv == 'm' ){
			$mvstr = '男子';
...
//							$html .= $league_list[$league_data]['match'][$match_no_index-1]['hon2'].'-'.$league_list[$league_data]['match'][$match_no_index-1]['win2'];
	...
	function __output_league_37_38_for_HTML( $navi_info, $league_param, $league_list, $entry_list, $mw )
	{
//echo $path;
//print_r($league_list);
		if( $mw == 'm' ){
...
//							$html .= $league_list[$league_data]['match'][$match_no_index-1]['hon2'].'-'.$league_list[$league_data]['match'][$match_no_index-1]['win2'];
	...
	function output_league_37_for_HTML( $navi_info, $league_param, $league_list, $entry_list )
	{
        $objPage = new form_page();
//print_r($league_list);
        $objPage->output_league_for_HTML( $navi_info, $league_param, $league_list, $entry_list, 'm', false );
		//__output_league_37_38_for_HTML( $path, get_league_parameter_37(), $league_list, $entry_list, 'm' );
	}

	function output_league_38_for_HTML( $navi_info, $league_param, $league_list, $entry_list )
	{
        $objPage = new form_page();
        $objPage->output_league_for_HTML( $navi_info, $league_param, $league_list, $entry_list, 'w', false );
		//__output_league_37_38_for_HTML( $path, get_league_parameter_38(), $league_list, $entry_list, 'w' );
	}
	...
	function __output_league_37_38_for_Excel_one( $objPage, $sheet, $col, $row, $league_param, $league_list, $entry_list, $mv )
	{
//print_r($league_list);
		if( $mv == 'm' ){
			$mvstr = '男子';
	...
	function __output_league_37_38_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list, $mw )
	{
//print_r($league_list);
		if( $mw == 'm' ){
			$mwstr = '男子';
...
//echo "1:",$mg_range1,':',$mg_range2,'<br />';
	...
	function output_league_37_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list )
	{
		return __output_league_37_38_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list, 'm' );
	}

	function output_league_38_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list )
	{
		return __output_league_37_38_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list, 'w' );
	}

	//---------------------------------------------------------------
	//
	//---------------------------------------------------------------
	function __output_league_match_for_HTML2_37_38( $objPage, $path, $league_list, $entry_list, $mv )
	{
		if( $mv == 'm' ){
			$mvstr = '男子';
		} else {
	...
	function output_league_match_for_HTML2_37( $navi_info, $league_param, $league_list, $entry_list )
	{
		//__output_league_match_for_HTML2_37_38( $objPage, $path, $league_list, $entry_list, 'm' );
        $objPage = new form_page();
        $objPage->output_league_match_for_HTML2( $navi_info, $league_param, $league_list, $entry_list, 'm' );
	}

	function output_league_match_for_HTML2_38( $navi_info, $league_param, $league_list, $entry_list )
	{
		//__output_league_match_for_HTML2_37_38( $objPage, $path, $league_list, $entry_list, 'w' );
        $objPage = new form_page();
	...
	function __output_league_match_for_excel_37_38( $objPage, $series_info, $league_param, $league_list, $entry_list, $mw )
	{
		if( $mw == 'm' ){
			$mwstr = '男子';
		} else {
...
//exit;
	...
	function output_league_match_for_excel_37( $objPage, $series_info, $league_param, $league_list, $entry_list )
	{
		return __output_league_match_for_excel_37_38( $objPage, $series_info, $league_param, $league_list, $entry_list, 'm' );
	}

	function output_league_match_for_excel_38( $objPage, $series_info, $league_param, $league_list, $entry_list )
	{
		return __output_league_match_for_excel_37_38( $objPage, $series_info, $league_param, $league_list, $entry_list, 'w' );
	}
	...
	function __output_tournament_match_37_38_for_excel( $objPage, $series_info, $tournament_param, $tournament_list, $league_data, $entry_list, $mw )
	{
		if( $mw == 'm' ){
			$mwstr = '男子';
		} else {
...
//        $objPage->output_one_match_for_excel( $sheet, $col, $row, $series_info, $tournament_data['match'][7], $entry_list, $mv, 46, 46 );
	...
	function output_tournament_match_37_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list )
	{
		return __output_tournament_match_37_38_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list, 'm' );
	}

	function output_tournament_match_38_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list )
	{
		return __output_tournament_match_37_38_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list, 'w' );
	}
	...
	function __output_tournament_37_38_for_excel( $objPage, $series_info, $tournament_param, $tournament_list, $league_data, $entry_list, $mw )
	{
		if( $mw == 'm' ){
			$mwstr = '男子';
		} else {
...
//exit;
	...
	function __output_tournament_37_38_for_excel2( $objPage, $series_info, $tournament_param, $tournament_list, $league_data, $entry_list, $mw, $series_m, $series_w )
	{
		if( $mw == 'm' ){
			$mwstr = '男子';
		} else {
...
//exit;
	...
	function output_tournament_37_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list )
	{
		return __output_tournament_37_38_for_excel2( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list, 'm', 37, 38 );
	}

	function output_tournament_38_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list )
	{
		return __output_tournament_37_38_for_excel2( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list, 'w', 37, 38 );
	}
	...
	function __output_tournament_chart_37_38_for_excel( $objPage, $series_info, $tournament_list, $league_data, $entry_list, $mw )
	{
		if( $mw == 'm' ){
			$mwstr = '男子';
		} else {
	...
	function output_tournament_chart_37_for_excel( $objPage, $series_info, $tournament_data, $league_data, $entry_list )
	{
		return __output_tournament_chart_37_38_for_excel( $objPage, $series_info, $tournament_data, $league_data, $entry_list, 'm' );
	}

	function output_tournament_chart_38_for_excel( $objPage, $series_info, $tournament_data, $league_data, $entry_list )
	{
		return __output_tournament_chart_37_38_for_excel( $objPage, $series_info, $tournament_data, $league_data, $entry_list, 'w' );
	}
	...
	function __output_tournament_match_for_HTML2_37_38( $series_info, $tournament_list, $entry_list, $mw )
	{
		if( $mw == 'm' ){
			$mwstr = '男子';
		} else {
	...
	function output_tournament_match_for_HTML2_37( $series_info, $tournament_list, $entry_list )
	{
		__output_tournament_match_for_HTML2_37_38( $series_info, $tournament_list, $entry_list, 'm' );
	}

	function output_tournament_match_for_HTML2_38( $series_info, $tournament_list, $entry_list )
	{
		__output_tournament_match_for_HTML2_37_38( $series_info, $tournament_list, $entry_list, 'w' );
	}
	...
	function output_tournament_38_for_PDF( $tournament_data, $entry_list, $mv )
	{
	}

	function output_tournament_37_for_PDF( $tournament_data, $entry_list, $mv )
	{
//print_r($tournament_data);
		if( $mv == 'm' ){
			$mvstr = '男子';
...
exit;
	...
	function __output_tournament_37_38_for_HTML( $series_info, $tournament_list, $entry_list, $mv )
	{
//print_r($tournament_data);
//print_r($entry_list);
		if( $mv == 'm' ){
...
//exit;
	...
	function output_tournament_37_for_HTML( $series_info, $tournament_data, $entry_list )
	{
		__output_tournament_37_38_for_HTML( $series_info, $tournament_data, $entry_list, 'm' );
	}

	function output_tournament_38_for_HTML( $series_info, $tournament_data, $entry_list )
	{
		__output_tournament_37_38_for_HTML( $series_info, $tournament_data, $entry_list, 'w' );
	}
	...
	function __output_entry_data_list_all_1_excel37_38( $sheet, $series, $mv, $start_pos, $series_name, $kaisai_rev )
	{
		$c = new common();
	...
	function output_entry_data_list_all_1_excel37( $sheet )
	{
		$pos = __output_entry_data_list_all_1_excel37_38( $sheet, 36, 'm', 4, '小学生の部', 1 );
		$pos = __output_entry_data_list_all_1_excel37_38( $sheet, 37, 'm', $pos+1, '中学生男子の部', 1 );
		$pos = __output_entry_data_list_all_1_excel37_38( $sheet, 38, 'w', $pos+1, '中学生女子の部', 1 );
		$pos = __output_entry_data_list_all_1_excel37_38( $sheet, 39, 'm', $pos+1, '成年男子の部', 1 );
		$pos = __output_entry_data_list_all_1_excel37_38( $sheet, 40, 'w', $pos+1, '成年女子の部', 1 );
		return false;
	}

	function output_entry_data_list_all_1_excel38( $sheet )
	{
		$pos = __output_entry_data_list_all_1_excel37_38( $sheet, 36, 'm', 4, '小学生の部', 1 );
		$pos = __output_entry_data_list_all_1_excel37_38( $sheet, 37, 'm', $pos+1, '中学生男子の部', 1 );
		$pos = __output_entry_data_list_all_1_excel37_38( $sheet, 38, 'w', $pos+1, '中学生女子の部', 1 );
	...
	function __get_entry_data_list2_37_38( $series )
	{
		$dbs = db_connect( DATABASE_HOST, DATABASE_USER, DATABASE_PASSWORD, DATABASE_NAME );
		$sql = 'select * from `entry_info`'
			.' where `series`='.$series        //.' and `year`='.$_SESSION['auth']['year']
	...
	function get_entry_data_list2_37()
	{
		return __get_entry_data_list2_37_38( 37 );
	}

	function get_entry_data_list2_38()
	{
		return __get_entry_data_list2_37_38( 38 );
	}

	//--------------------------------------------------------------

	function __get_entry_data_for_draw_csv_37_38( $list, $series )
	{
		$c = new common();
	...
	function get_entry_data_for_draw_csv_37( $list )
	{
		return array(
			'csv' => __get_entry_data_for_draw_csv_37_38( $list, 16 ),
			'file' => 'dantai_m.csv'
		);
	}

	function get_entry_data_for_draw_csv_38( $list )
	{
		return array(
			'csv' => __get_entry_data_for_draw_csv_37_38( $list, 17 ),
			'file' => 'dantai_w.csv'
		);
	}
	...
	function __output_realtime_html_for_one_board_37_38( $place, $place_match_no )
	{
		global $navi_info;
...
*/
	...
	function output_realtime_html_for_one_board_37( $place, $place_match_no )
	{
		//return __output_realtime_html_for_one_board_37_38( $place, $place_match_no );
		return '';
	}

	function output_realtime_html_for_one_board_38( $place, $place_match_no )
	{
		//return __output_realtime_html_for_one_board_37_38( $place, $place_match_no );
		return '';
	}
	...
	//
	//---------------------------------------------------------------
	function draw_entry_data_list_37( $series_info )
	{
        require_once dirname(dirname(dirname(__FILE__))).'/phpExcel/Classes/PHPExcel.php';
        require_once dirname(dirname(dirname(__FILE__))).'/phpExcel/Classes/PHPExcel/IOFactory.php';
	...
	function draw_entry_data_list_38( $series_info )
	{
        require_once dirname(dirname(dirname(__FILE__))).'/phpExcel/Classes/PHPExcel.php';
        require_once dirname(dirname(dirname(__FILE__))).'/phpExcel/Classes/PHPExcel/IOFactory.php';
        $file_name = 'draw' . date('YmdHis') . sprintf("%04d",microtime()*1000) . '.xls';
