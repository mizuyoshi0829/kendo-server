<?php
	...
	function get_tournament_parameter_51()
	{
		$param = array(
			'mw' => 'w',
			'team_num' => 64,
	...
	function output_entry_data_list_all_1_excel51( $sheet )
	{
        $objPage = new form_page();
        $objPage->output_entry_data_list_all_1_excel( $sheet, 51, '', 3, '' );
        return false;
	}

	//--------------------------------------------------------------

	function output_entry_data_list_all_2_excel51( $sheet, $series, $series_mw, $start_pos, $series_name )
	{
		$c = new common();
	...
	function get_entry_data_list2_51( $series=51 )
	{
		$c = new common();
	...
	function get_entry_data_51_list_for_PDF( $series, $series_mw )
	{
		$c = new common();
...
//print_r($list);
	...
	function get_entry_data_for_draw_csv_51( $list, $series, $series_mw )
	{
		$c = new common();
		$preftbl = $c->get_pref_array();
		$dbs = db_connect( DATABASE_HOST, DATABASE_USER, DATABASE_PASSWORD, DATABASE_NAME );
