<?php
	...
	function __output_tournament_34_35_for_excel( $objPage, $series_info, $tournament_data, $entry_list, $mw )
    {
...
//exit;
        ...
        $file_name = $series_info['reg_year'] . '北信越大会個人トーナメント表_' . $mwstr . '.xlsx';
        //$file_name = 'H29nanshinJuniorKojinTounamentResults_' . $mw . '.xlsx';
        $file_path = $series_info['output_path'] . '/' . $file_name;
        $excel = new PHPExcel();
        $reader = PHPExcel_IOFactory::createReader('Excel2007');
        $excel = $reader->load(dirname(__FILE__).'/hokushinEtsuJuniorKojinTournament.xlsx');
        ...
        if( $tournament_data['data'][0]['match'][0]['winner'] == 1 ){
            $sheet->setCellValue( 'A71', $tournament_data['data'][0]['match'][0]['player1_name'].'('.$tournament_data['data'][0]['match'][0]['player1_belonging_to_name'].')' );
        } else if( $tournament_data['data'][0]['match'][0]['winner'] == 2 ){
            $sheet->setCellValue( 'A71', $tournament_data['data'][0]['match'][0]['player2_name'].'('.$tournament_data['data'][0]['match'][0]['player2_belonging_to_name'].')' );
        }
        if( $tournament_data['data'][0]['match'][0]['winner'] == 1 ){
            $sheet->setCellValue( 'F71', $tournament_data['data'][0]['match'][0]['player2_name'].'('.$tournament_data['data'][0]['match'][0]['player2_belonging_to_name'].')' );
        } else if( $tournament_data['data'][0]['match'][0]['winner'] == 2 ){
            $sheet->setCellValue( 'F71', $tournament_data['data'][0]['match'][0]['player1_name'].'('.$tournament_data['data'][0]['match'][0]['player1_belonging_to_name'].')' );
        }
        if( $tournament_data['data'][0]['match'][1]['winner'] == 1 ){
            $sheet->setCellValue( 'L71', $tournament_data['data'][0]['match'][1]['player2_name'].'('.$tournament_data['data'][0]['match'][1]['player2_belonging_to_name'].')' );
        } else if( $tournament_data['data'][0]['match'][1]['winner'] == 2 ){
            $sheet->setCellValue( 'L71', $tournament_data['data'][0]['match'][1]['player1_name'].'('.$tournament_data['data'][0]['match'][1]['player1_belonging_to_name'].')' );
        }
        if( $tournament_data['data'][0]['match'][2]['winner'] == 1 ){
            $sheet->setCellValue( 'R71', $tournament_data['data'][0]['match'][2]['player2_name'].'('.$tournament_data['data'][0]['match'][2]['player2_belonging_to_name'].')' );
        } else if( $tournament_data['data'][0]['match'][2]['winner'] == 2 ){
            $sheet->setCellValue( 'R71', $tournament_data['data'][0]['match'][2]['player1_name'].'('.$tournament_data['data'][0]['match'][2]['player1_belonging_to_name'].')' );
        }

        if( $tournament_data['data'][0]['match'][3]['winner'] == 1 ){
            $sheet->setCellValue( 'A75', $tournament_data['data'][0]['match'][3]['player2_name'].'('.$tournament_data['data'][0]['match'][3]['player2_belonging_to_name'].')' );
        } else if( $tournament_data['data'][0]['match'][3]['winner'] == 2 ){
            $sheet->setCellValue( 'A75', $tournament_data['data'][0]['match'][3]['player1_name'].'('.$tournament_data['data'][0]['match'][3]['player1_belonging_to_name'].')' );
        }
        if( $tournament_data['data'][0]['match'][4]['winner'] == 1 ){
            $sheet->setCellValue( 'F75', $tournament_data['data'][0]['match'][4]['player2_name'].'('.$tournament_data['data'][0]['match'][4]['player2_belonging_to_name'].')' );
        } else if( $tournament_data['data'][0]['match'][4]['winner'] == 2 ){
            $sheet->setCellValue( 'F75', $tournament_data['data'][0]['match'][4]['player1_name'].'('.$tournament_data['data'][0]['match'][4]['player1_belonging_to_name'].')' );
        }
        if( $tournament_data['data'][0]['match'][5]['winner'] == 1 ){
            $sheet->setCellValue( 'L75', $tournament_data['data'][0]['match'][5]['player2_name'].'('.$tournament_data['data'][0]['match'][5]['player2_belonging_to_name'].')' );
        } else if( $tournament_data['data'][0]['match'][5]['winner'] == 2 ){
            $sheet->setCellValue( 'L75', $tournament_data['data'][0]['match'][5]['player1_name'].'('.$tournament_data['data'][0]['match'][5]['player1_belonging_to_name'].')' );
        }
        if( $tournament_data['data'][0]['match'][6]['winner'] == 1 ){
            $sheet->setCellValue( 'R75', $tournament_data['data'][0]['match'][6]['player2_name'].'('.$tournament_data['data'][0]['match'][6]['player2_belonging_to_name'].')' );
        } else if( $tournament_data['data'][0]['match'][6]['winner'] == 2 ){
            $sheet->setCellValue( 'R75', $tournament_data['data'][0]['match'][6]['player1_name'].'('.$tournament_data['data'][0]['match'][6]['player1_belonging_to_name'].')' );
        }
	...
	function output_tournament_34_for_excel( $objPage, $series_info, $tournament_data, $entry_list )
	{
		return __output_tournament_34_35_for_excel( $objPage, $series_info, $tournament_data, $entry_list, 'm' );
	}

	function output_tournament_35_for_excel( $objPage, $series_info, $tournament_data, $entry_list )
	{
		return __output_tournament_34_35_for_excel( $objPage, $series_info, $tournament_data, $entry_list, 'w' );
	}
...
//exit;
	...
	function output_entry_data_list_all_1_excel_34( $sheet )
	{
		...
		__output_entry_data_list_all_1_excel34_35( $sheet, 35, 'w', $pos, '個人戦女子' );
		return true;
	}
	...
	function output_entry_data_list_all_2_excel_34( $sheet )
	{
		...
		__output_entry_data_list_all_2_excel_34_35( $sheet, 35, 'w', $pos, '個人戦女子' );
		return false;
	}
