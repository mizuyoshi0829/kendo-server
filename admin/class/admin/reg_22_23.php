<?php
	...
	function __get_tournament_parameter_22_23()
	{
		$param = array(
			'mw' => 'w',
			'team_num' => 16,
	...
	function get_tournament_parameter_22()
	{
		__get_tournament_parameter_22_23();
	}

	function get_tournament_parameter_23()
	{
		__get_tournament_parameter_22_23();
	}
	...
	function __output_tournament_22_23_for_excel( $objPage, $path, $tournament_data, $entry_list, $mw )
    {
...
//exit;
        ...
        $file_name = 'H28allnaganoKojinTounamentResults_' . $mw . '.xlsx';
        ...
        $match_level = intval( $tournament_data['data']['match_level'] );
        $tournament_player_num = intval( $tournament_data['data']['tournament_player_num'] );
        $tournament_player_num2 = intval( $tournament_data['data']['tournament_player_num']/2 );
        $col = 0;
        $row = 5;
        $index = 1;
        for( $player = 0; $player < $tournament_player_num; $player++ ){
            ...
            if( $tournament_data['data']['player'][$player]['info'] == 0 ){ continue; }
            if( $player < $tournament_player_num2 ){
                $sheet->setCellValueByColumnAndRow( $col, $row, $index );
                $sheet->setCellValueByColumnAndRow( $col+1, $row, $tournament_data['data']['player'][$player]['disp_name'] );
                $sheet->setCellValueByColumnAndRow( $col+2, $row, '('.$tournament_data['data']['player'][$player]['school_name_ryaku'].')' );
            } else {
                $sheet->setCellValueByColumnAndRow( $col, $row, $tournament_data['data']['player'][$player]['disp_name'] );
                $sheet->setCellValueByColumnAndRow( $col+1, $row, '('.$tournament_data['data']['player'][$player]['school_name_ryaku'].')' );
        ...
        for( $level = 0; $level < $match_level-1; $level++ ){
            ...
            for( $m = 0; $m < $match_num; $m++ ){
                ...
                if( $tournament_data['data']['match'][$match]['place'] == 'no_match' ){
                    ...
                    $red = 1;
                    if(
                        ( ( $match % 2 ) == 1 && $tournament_data['data']['match'][$up]['winner'] == 1 )
                        || ( ( $match % 2 ) == 0 && $tournament_data['data']['match'][$up]['winner'] == 2 )
                    ){
                    ...
                    $winstrs = $objPage->get_kojin_tounament_chart_winstring_for_excel( $tournament_data['data']['match'][$match] );
                    $winstr = '';
                    for( $wi = 0; $wi < 3; $wi++ ){
                        if( $winstrs[1][$wi] == '' ){
                            $winstr .= '　';
                    ...
                    if( $tournament_data['data']['match'][$match]['winner'] == 1 ){
                    ...
                    if( $tournament_data['data']['match'][$match]['winner'] == 2 ){
                    ...
                    if( $tournament_data['data']['match'][$match]['extra'] == 1 ){
        ...
        if( $tournament_data['data']['match'][0]['winner'] == 1 ){
            ...
            $sheet->setCellValue( $col1.($row-4), $tournament_data['data']['match'][0]['player1_name'] );
            ...
            $sheet->setCellValue( $col1.($row-4), $tournament_data['data']['match'][0]['player2_name'] );
            $sheet->mergeCells( $col1.($row-4).':'.$col2.($row-3) );
            $sheet->getStyle($col1.($row-4))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
            $sheet->getStyle($col1.($row-4))->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
        } else {
...
/*
        ...
        if( $tournament_data['data']['match'][1]['winner'] == 1 ){
            $sheet->setCellValue( 'B'.$row, $tournament_data['data']['match'][1]['player2_name'] );
        } else if( $tournament_data['data']['match'][1]['winner'] == 2 ){
            $sheet->setCellValue( 'B'.$row, $tournament_data['data']['match'][1]['player1_name'] );
        }
        if( $tournament_data['data']['match'][2]['winner'] == 1 ){
            $sheet->setCellValue( 'B'.($row+4), $tournament_data['data']['match'][2]['player2_name'] );
        } else if( $tournament_data['data']['match'][2]['winner'] == 2 ){
            $sheet->setCellValue( 'B'.($row+4), $tournament_data['data']['match'][2]['player1_name'] );
        }
        ...
        if( $tournament_data['data']['match'][$tournament_player_num-1]['winner'] == 1 ){
            ...
            $sheet->setCellValue( 'H'.($row+3), $tournament_data['data']['match'][$tournament_player_num-1]['player1_name'] );
        ...
        } else if( $tournament_data['data']['match'][$tournament_player_num-1]['winner'] == 2 ){
            ...
            $sheet->getStyle( 'F'.($row+4) )->applyFromArray( $styleArrayHR );
            $sheet->setCellValue( 'H'.($row+3), $tournament_data['data']['match'][$tournament_player_num-1]['player2_name'] );
            $sheet->mergeCells( 'H'.($row+3).':'.'J'.($row+4) );
            $sheet->getStyle('H'.($row+3))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
            $sheet->getStyle('H'.($row+3))->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
        } else {
        ...
        $winstrs = $objPage->get_kojin_tounament_chart_winstring_for_excel( $tournament_data['data']['match'][$tournament_player_num-1] );
        $winstr = '';
        for( $wi = 0; $wi < 3; $wi++ ){
            if( $winstrs[1][$wi] == '' ){
                $winstr .= '　';
        ...
        if( $tournament_data['data']['match'][$tournament_player_num-1]['extra'] == 1 ){
...
*/
        ...
        if( $tournament_data['data']['match'][0]['winner'] == 1 ){
            $sheet->setCellValueByColumnAndRow( 2, $row, $tournament_data['data']['match'][0]['player1_name'] );
            $sheet->setCellValueByColumnAndRow( 5, $row, '('.$tournament_data['data']['match'][0]['player1_school_name_ryaku'].')' );
        } else if( $tournament_data['data']['match'][0]['winner'] == 2 ){
            $sheet->setCellValueByColumnAndRow( 2, $row, $tournament_data['data']['match'][0]['player2_name'] );
            $sheet->setCellValueByColumnAndRow( 5, $row, '('.$tournament_data['data']['match'][0]['player2_school_name_ryaku'].')' );
        }
        ...
        if( $tournament_data['data']['match'][1]['winner'] == 1 ){
            $sheet->setCellValueByColumnAndRow( 2, $row, $tournament_data['data']['match'][1]['player2_name'] );
            $sheet->setCellValueByColumnAndRow( 5, $row, '('.$tournament_data['data']['match'][1]['player2_school_name_ryaku'].')' );
        } else if( $tournament_data['data']['match'][1]['winner'] == 2 ){
            $sheet->setCellValueByColumnAndRow( 2, $row, $tournament_data['data']['match'][1]['player1_name'] );
            $sheet->setCellValueByColumnAndRow( 5, $row, '('.$tournament_data['data']['match'][1]['player1_school_name_ryaku'].')' );
        }
        $sheet->getStyle('A'.($row).':F'.$row)->getFont()->setSize(12);
        $sheet->getRowDimension($row)->setRowHeight(16);
        $row++;
        $sheet->setCellValueByColumnAndRow( 1, $row, '３位' );
        if( $tournament_data['data']['match'][2]['winner'] == 1 ){
            $sheet->setCellValueByColumnAndRow( 2, $row, $tournament_data['data']['match'][2]['player2_name'] );
            $sheet->setCellValueByColumnAndRow( 5, $row, '('.$tournament_data['data']['match'][2]['player2_school_name_ryaku'].')' );
        } else if( $tournament_data['data']['match'][2]['winner'] == 2 ){
            $sheet->setCellValueByColumnAndRow( 2, $row, $tournament_data['data']['match'][2]['player1_name'] );
            $sheet->setCellValueByColumnAndRow( 5, $row, '('.$tournament_data['data']['match'][2]['player1_school_name_ryaku'].')' );
        }
        $sheet->getStyle('A'.($row).':F'.$row)->getFont()->setSize(12);
        $sheet->getRowDimension($row)->setRowHeight(16);
        $row++;
/*
        ...
        if( $tournament_data['data']['match'][3]['winner'] == 2 ){
            $sheet->setCellValueByColumnAndRow( 2, $row, $tournament_data['data']['match'][3]['player1_name'] );
            $sheet->setCellValueByColumnAndRow( 5, $row, '('.$tournament_data['data']['match'][3]['player1_school_name_ryaku'].')' );
        } else if( $tournament_data['data']['match'][3]['winner'] == 1 ){
            $sheet->setCellValueByColumnAndRow( 2, $row, $tournament_data['data']['match'][3]['player2_name'] );
            $sheet->setCellValueByColumnAndRow( 5, $row, '('.$tournament_data['data']['match'][3]['player2_school_name_ryaku'].')' );
        }
        $sheet->getStyle('A'.($row).':F'.$row)->getFont()->setSize(12);
        $sheet->getRowDimension($row)->setRowHeight(16);
        $row++;
        $sheet->setCellValueByColumnAndRow( 1, $row, 'ベスト８' );
        if( $tournament_data['data']['match'][4]['winner'] == 2 ){
            $sheet->setCellValueByColumnAndRow( 2, $row, $tournament_data['data']['match'][4]['player1_name'] );
            $sheet->setCellValueByColumnAndRow( 5, $row, '('.$tournament_data['data']['match'][4]['player1_school_name_ryaku'].')' );
        } else if( $tournament_data['data']['match'][4]['winner'] == 1 ){
            $sheet->setCellValueByColumnAndRow( 2, $row, $tournament_data['data']['match'][4]['player2_name'] );
            $sheet->setCellValueByColumnAndRow( 5, $row, '('.$tournament_data['data']['match'][4]['player2_school_name_ryaku'].')' );
        }
        $sheet->getStyle('A'.($row).':F'.$row)->getFont()->setSize(12);
        $sheet->getRowDimension($row)->setRowHeight(16);
        $row++;
        $sheet->setCellValueByColumnAndRow( 1, $row, 'ベスト８' );
        if( $tournament_data['data']['match'][5]['winner'] == 2 ){
            $sheet->setCellValueByColumnAndRow( 2, $row, $tournament_data['data']['match'][5]['player1_name'] );
            $sheet->setCellValueByColumnAndRow( 5, $row, '('.$tournament_data['data']['match'][5]['player1_school_name_ryaku'].')' );
        } else if( $tournament_data['data']['match'][5]['winner'] == 1 ){
            $sheet->setCellValueByColumnAndRow( 2, $row, $tournament_data['data']['match'][5]['player2_name'] );
            $sheet->setCellValueByColumnAndRow( 5, $row, '('.$tournament_data['data']['match'][5]['player2_school_name_ryaku'].')' );
        }
        $sheet->getStyle('A'.($row).':F'.$row)->getFont()->setSize(12);
        $sheet->getRowDimension($row)->setRowHeight(16);
        $row++;
        $sheet->setCellValueByColumnAndRow( 1, $row, 'ベスト８' );
        if( $tournament_data['data']['match'][6]['winner'] == 2 ){
            $sheet->setCellValueByColumnAndRow( 2, $row, $tournament_data['data']['match'][6]['player1_name'] );
            $sheet->setCellValueByColumnAndRow( 5, $row, '('.$tournament_data['data']['match'][6]['player1_school_name_ryaku'].')' );
        } else if( $tournament_data['data']['match'][6]['winner'] == 1 ){
            $sheet->setCellValueByColumnAndRow( 2, $row, $tournament_data['data']['match'][6]['player2_name'] );
            $sheet->setCellValueByColumnAndRow( 5, $row, '('.$tournament_data['data']['match'][6]['player2_school_name_ryaku'].')' );
        }
        $sheet->getStyle('A'.($row).':F'.$row)->getFont()->setSize(12);
        $sheet->getRowDimension($row)->setRowHeight(16);
        $row++;
*/
	...
	function output_tournament_22_for_excel( $objPage, $path, $tournament_data, $entry_list )
	{
		return __output_tournament_22_23_for_excel( $objPage, $path, $tournament_data, $entry_list, 'm' );
	}

	function output_tournament_23_for_excel( $objPage, $path, $tournament_data, $entry_list )
	{
		return __output_tournament_22_23_for_excel( $objPage, $path, $tournament_data, $entry_list, 'w' );
	}
	...
	function output_tournament_match_for_HTML2_22( $objPage, $path, $tournament_list, $entry_list, $mv )
	{
		if( $mv == 'm' ){
			$mvstr = '男子';
		} else {
	...
	function __output_tournament_22_23_for_HTML( $path, $tournament_data, $entry_list, $mv )
	{
//echo '<!-- ';
//print_r($tournament_data);
//echo ' -->';
...
/*
		...
		$pdf .= '  <table style="border-collapse: separate; border-spacing: 0;">' . "\n";
		$pdf .= '<tr>' . "\n";
		$pdf .= '<td class="div_result_tournament_name_name" rowspan="'.$table_name_rowspan.'" lang="ja">' . $tournament_data['data']['match'][31]['player1_name'] . '</td>' . "\n";
		$pdf .= '<td height="'.$table_height.'" class="div_border_b';
            if( $tournament_data['data']['match'][31]['winner'] == 1 ){ $pdf .= '_win'; }
		...
		$pdf .= '<tr><td height="'.$table_height.'" class="div_border_r';
            if( $tournament_data['data']['match'][31]['winner'] == 1 ){ $pdf .= '_win'; }
                $pdf .= ' div_result_one_tournament">';
            if( $tournament_data['data']['match'][31]['winner'] != 0 ){ $pdf .= $tournament_data['data']['match'][31]['win1'] . ' - ' . $tournament_data['data']['match'][31]['win2']; }
        ...
        if( $tournament_data['data']['match'][31]['winner'] == 1 ){
		    $pdf .= $tournament_data['data']['match'][31]['player1_name'];
        } else if( $tournament_data['data']['match'][31]['winner'] == 2 ){
		    $pdf .= $tournament_data['data']['match'][31]['player2_name'];
        }
		$pdf .= '</td></tr>' . "\n";
		$pdf .= '<tr><td height="'.$table_height.'" class="div_result_tournament_name_name" lang="ja"></td><td height="'.$table_height.'" class="div_border_r';
            if( $tournament_data['data']['match'][31]['winner'] == 2 ){ $pdf .= '_win'; }
                $pdf .= ' div_result_one_tournament"></td></tr>' . "\n";
		$pdf .= '<tr>' . "\n";
		$pdf .= '<td class="div_result_tournament_name_name" rowspan="'.$table_name_rowspan.'" lang="ja">' . $tournament_data['data']['match'][31]['player2_name'] . '<td height="'.$table_height.'" class="div_border_br';
            if( $tournament_data['data']['match'][31]['winner'] == 2 ){ $pdf .= '_win'; }
...
//exit;
	...
	function output_tournament_22_for_HTML( $path, $tournament_data, $entry_list )
	{
		__output_tournament_22_23_for_HTML( $path, $tournament_data, $entry_list, 'm' );
	}

	function output_tournament_23_for_HTML( $path, $tournament_data, $entry_list )
	{
		__output_tournament_22_23_for_HTML( $path, $tournament_data, $entry_list, 'w' );
	}
	...
	function __output_entry_data_list_all_1_excel22_23( $sheet, $series, $series_mw, $start_pos, $series_name )
	{
		$c = new common();
	...
	function output_entry_data_list_all_1_excel22( $sheet )
	{
		$pos = __output_entry_data_list_all_1_excel22_23( $sheet, 22, 'm', 4, '個人戦男子' );
		__output_entry_data_list_all_1_excel22_23( $sheet, 23, 'w', $pos, '個人戦女子' );
		return true;
	}

	function output_entry_data_list_all_1_excel23( $sheet )
	{
		$pos = __output_entry_data_list_all_1_excel22_23( $sheet, 22, 'm', 4, '個人戦男子' );
		__output_entry_data_list_all_1_excel22_23( $sheet, 23, 'w', $pos, '個人戦女子' );
		return true;
	...
	function __output_entry_data_list_all_2_excel22_23( $sheet, $series, $series_mw, $start_pos, $series_name )
	{
		$c = new common();
	...
	function output_entry_data_list_all_2_excel22( $sheet )
	{
		$pos = __output_entry_data_list_all_2_excel22_23( $sheet, 22, 'm', 4, '個人戦男子' );
		__output_entry_data_list_all_2_excel22_23( $sheet, 23, 'w', $pos, '個人戦女子' );
		return false;
	}

	function output_entry_data_list_all_2_excel23( $sheet )
	{
		$pos = __output_entry_data_list_all_2_excel22_23( $sheet, 22, 'm', 4, '個人戦男子' );
		__output_entry_data_list_all_2_excel22_23( $sheet, 23, 'w', $pos, '個人戦女子' );
		return false;
	...
	function __get_entry_data_list2_22_23( $series, $series_mw )
	{
		$dbs = db_connect( DATABASE_HOST, DATABASE_USER, DATABASE_PASSWORD, DATABASE_NAME );
		$sql = 'select * from `entry_info`'
			.' where `series`='.$series.' and `year`='.__REG_SERIES_YEAR__
	...
	function get_entry_data_list2_22()
	{
		return __get_entry_data_list2_22_23( 22, 'm' );
	}

	function get_entry_data_list2_23()
	{
		return __get_entry_data_list2_22_23( 23, 'w' );
	}

	//--------------------------------------------------------------

	function __get_entry_data_22_23_list_for_PDF( $series, $series_mw )
	{
		$c = new common();
...
//print_r($list);
	...
	function get_entry_data_22_list_for_PDF()
	{
		return __get_entry_data_22_23_list_for_PDF( 22, 'm' );
	}

	function get_entry_data_23_list_for_PDF()
	{
		return __get_entry_data_22_23_list_for_PDF( 23, 'w' );
	}

	//--------------------------------------------------------------

	function __get_entry_data_for_draw_csv_22_23( $list, $series, $series_mw )
	{
		$c = new common();
		$preftbl = $c->get_pref_array();
		$dbs = db_connect( DATABASE_HOST, DATABASE_USER, DATABASE_PASSWORD, DATABASE_NAME );
	...
	function get_entry_data_for_draw_csv_22( $list )
	{
		return array(
			'csv' => __get_entry_data_for_draw_csv_22_23( $list, 22, 'm' ),
			'file' => 'kojin_m.csv'
		);
	}

	function get_entry_data_for_draw_csv_23( $list )
	{
		return array(
			'csv' => __get_entry_data_for_draw_csv_22_23( $list, 23, 'w' ),
			'file' => 'kojin_w.csv'
		);
	}
	...
	function __output_realtime_html_for_one_board_22_23( $place, $place_match_no )
	{
		global $navi_info;
...
*/
	...
	function output_realtime_html_for_one_board_22( $place, $place_match_no )
	{
		return __output_realtime_html_for_one_board_22_23( $place, $place_match_no );
	}

	function output_realtime_html_for_one_board_23( $place, $place_match_no )
	{
		return __output_realtime_html_for_one_board_22_23( $place, $place_match_no );
	}
	...
	function __output_tournament_chart_22_23_for_HTML( $tournament_data, $entry_list )
	{
//echo '<!-- ';
//print_r($tournament_data);
//echo ' -->';
...
//exit;
	...
	function output_tournament_chart_22_for_HTML( $tournament_data, $entry_list )
	{
		return __output_tournament_chart_22_23_for_HTML( $tournament_data, $entry_list );
	}

	function output_tournament_chart_23_for_HTML( $tournament_data, $entry_list )
	{
		return __output_tournament_chart_22_23_for_HTML( $tournament_data, $entry_list );
	}
