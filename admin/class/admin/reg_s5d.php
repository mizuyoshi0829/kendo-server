<?php
    ...
    function __get_league_parameter_24_25( $series_mw )
    {
        $param = array(
            'mw' => $series_mw,
            'team_num' => 3,
    ...
    function get_league_parameter_24()
    {
        return __get_league_parameter_24_25( 'm' );
    }

    function get_league_parameter_25()
    {
        return __get_league_parameter_24_25( 'w' );
    }

    function __get_tournament_parameter_24_25()
    {
        $param = array(
            'mw' => $series_mw,
            'team_num' => 8,
    ...
    function get_tournament_parameter_24()
    {
        __get_tournament_parameter_24_25( 'm' );
    }

    function get_tournament_parameter_25()
    {
        __get_tournament_parameter_24_25( 'w' );
    }

    function __get_entry_data_24_25_list_for_PDF( $series, $series_mw, $kaisai_rev )
    {
        $c = new common();
...
*/
    ...
    function get_entry_data_24_list_for_PDF()
    {
        return __get_entry_data_24_25_list_for_PDF( 16, 'm', 1 );
    }

    function get_entry_data_25_list_for_PDF()
    {
        return __get_entry_data_24_25_list_for_PDF( 17, 'w', 1 );
    }


    function get_entry_data_list_24_sql( $mw )
    {
    ...
    function output_league_24_for_HTML_2( $league_list, $entry_list, $mv )
    {
//print_r($league_list);
        if( $mv == 'm' ){
            $mvstr = '男子';
...
//                            $html .= $league_list[$league_data]['match'][$match_no_index-1]['hon2'].'-'.$league_list[$league_data]['match'][$match_no_index-1]['win2'];
    ...
    function __output_league_24_25_for_HTML( $navi_info, $league_param, $league_list, $entry_list, $mw )
    {
//echo $path;
//print_r($league_list);
        if( $mw == 'm' ){
...
//                            $html .= $league_list[$league_data]['match'][$match_no_index-1]['hon2'].'-'.$league_list[$league_data]['match'][$match_no_index-1]['win2'];
    ...
    function output_league_24_for_HTML( $navi_info, $league_param, $league_list, $entry_list )
    {
        $objPage = new form_page();
        $objPage->output_league_for_HTML( $navi_info, $league_param, $league_list, $entry_list, 'm', false );
        //__output_league_24_25_for_HTML( $path, get_league_parameter_24(), $league_list, $entry_list, 'm' );
    }

    function output_league_25_for_HTML( $navi_info, $league_param, $league_list, $entry_list )
    {
        $objPage = new form_page();
        $objPage->output_league_for_HTML( $navi_info, $league_param, $league_list, $entry_list, 'w', false );
        //__output_league_24_25_for_HTML( $path, get_league_parameter_25(), $league_list, $entry_list, 'w' );
    }
    ...
    function __output_league_24_25_for_Excel_one( $objPage, $sheet, $col, $row, $league_param, $league_list, $entry_list, $mv )
    {
//print_r($league_list);
        if( $mv == 'm' ){
            $mvstr = '男子';
    ...
    function __output_league_24_25_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list, $mw )
    {
//print_r($league_list);
        if( $mw == 'm' ){
            $mwstr = '男子';
        ...
        $file_name = 'H30nanshinJuniorDantaiLeagueResults_' . $mw . '.xls';
...
//echo "1:",$mg_range1,':',$mg_range2,'<br />';
    ...
    function output_league_24_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list )
    {
        return __output_league_24_25_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list, 'm' );
    }

    function output_league_25_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list )
    {
        return __output_league_24_25_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list, 'w' );
    }

    //---------------------------------------------------------------
    //
    //---------------------------------------------------------------
    function __output_league_match_for_HTML2_24_25( $objPage, $path, $league_list, $entry_list, $mv )
    {
        if( $mv == 'm' ){
            $mvstr = '男子';
        } else {
    ...
    function output_league_match_for_HTML2_24( $navi_info, $league_param, $league_list, $entry_list )
    {
        //__output_league_match_for_HTML2_24_25( $objPage, $path, $league_list, $entry_list, 'm' );
        $objPage = new form_page();
        $objPage->output_league_match_for_HTML2( $navi_info, $league_param, $league_list, $entry_list, 'm' );
    }

    function output_league_match_for_HTML2_25( $navi_info, $league_param, $league_list, $entry_list )
    {
        //__output_league_match_for_HTML2_24_25( $objPage, $path, $league_list, $entry_list, 'w' );
        $objPage = new form_page();
    ...
    function __output_league_match_for_excel_24_25( $objPage, $series_info, $league_param, $league_list, $entry_list, $mw )
    {
        if( $mw == 'm' ){
            $mwstr = '男子';
        } else {
...
//print_r($league_list);
//exit;
        $file_name = 'H30nanshinJuniorDantaiLeagueMatchResults_'.$mw.'.xls';
        $file_path = $series_info['output_path'] . '/' . $file_name;
    ...
    function output_league_match_for_excel_24( $objPage, $series_info, $league_param, $league_list, $entry_list )
    {
        return __output_league_match_for_excel_24_25( $objPage, $series_info, $league_param, $league_list, $entry_list, 'm' );
    }

    function output_league_match_for_excel_25( $objPage, $series_info, $league_param, $league_list, $entry_list )
    {
        return __output_league_match_for_excel_24_25( $objPage, $series_info, $league_param, $league_list, $entry_list, 'w' );
    }
    ...
    function __output_tournament_match_24_25_for_excel( $objPage, $series_info, $tournament_param, $tournament_list, $league_data, $entry_list, $mw )
    {
        if( $mw == 'm' ){
            $mwstr = '男子';
        } else {
        ...
        require_once dirname(dirname(dirname(__FILE__))).'/phpExcel/Classes/PHPExcel.php';
        require_once dirname(dirname(dirname(__FILE__))).'/phpExcel/Classes/PHPExcel/IOFactory.php';
        $file_name = 'H30nanshinJuniorDantaiTournamentMatchResults_' . $mw . '.xls';
        $file_path = $series_info['output_path'] . '/' . $file_name;
    ...
    function output_tournament_match_24_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list )
    {
        return __output_tournament_match_24_25_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list, 'm' );
    }

    function output_tournament_match_25_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list )
    {
        return __output_tournament_match_24_25_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list, 'w' );
    }
    ...
    function __output_tournament_24_25_for_excel( $objPage, $series_info, $tournament_param, $tournament_list, $league_data, $entry_list, $mw )
    {
        if( $mw == 'm' ){
            $mwstr = '男子';
        } else {
...
//exit;
        $file_name = 'H30nanshinJuniorDantaiTounamentResults_' . $mw . '.xls';
        $file_path = $series_info['output_path'] . '/' . $file_name;
        $excel = new PHPExcel();
        $excel->setActiveSheetIndex( 0 );        //何番目のシートに有効にするか
        $sheet = $excel->getActiveSheet();    //有効になっているシートを取得
    ...
    function output_tournament_24_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list )
    {
        return __output_tournament_24_25_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list, 'm' );
    }

    function output_tournament_25_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list )
    {
        return __output_tournament_24_25_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list, 'w' );
    }
    ...
    function __output_tournament_chart_24_25_for_excel( $objPage, $series_info, $tournament_list, $league_data, $entry_list, $mw )
    {
        if( $mw == 'm' ){
            $mwstr = '男子';
        } else {
    ...
    function output_tournament_chart_24_for_excel( $objPage, $series_info, $tournament_data, $league_data, $entry_list )
    {
        return __output_tournament_chart_24_25_for_excel( $objPage, $series_info, $tournament_data, $league_data, $entry_list, 'm' );
    }

    function output_tournament_chart_25_for_excel( $objPage, $series_info, $tournament_data, $league_data, $entry_list )
    {
        return __output_tournament_chart_24_25_for_excel( $objPage, $series_info, $tournament_data, $league_data, $entry_list, 'w' );
    }
    ...
    function __output_tournament_match_for_HTML2_24_25( $series_info, $tournament_list, $entry_list, $mw )
    {
        if( $mw == 'm' ){
            $mwstr = '男子';
        } else {
    ...
    function output_tournament_match_for_HTML2_24( $series_info, $tournament_list, $entry_list )
    {
        __output_tournament_match_for_HTML2_24_25( $series_info, $tournament_list, $entry_list, 'm' );
    }

    function output_tournament_match_for_HTML2_25( $series_info, $tournament_list, $entry_list )
    {
        __output_tournament_match_for_HTML2_24_25( $series_info, $tournament_list, $entry_list, 'w' );
    }
    ...
    function output_tournament_25_for_PDF( $tournament_data, $entry_list, $mv )
    {
    }

    function output_tournament_24_for_PDF( $tournament_data, $entry_list, $mv )
    {
//print_r($tournament_data);
        if( $mv == 'm' ){
            $mvstr = '男子';
...
exit;
    ...
    function __output_tournament_24_25_for_HTML( $series_info, $tournament_list, $entry_list, $mv )
    {
//print_r($tournament_data);
//print_r($entry_list);
        if( $mv == 'm' ){
...
//exit;
    ...
    function output_tournament_24_for_HTML( $series_info, $tournament_data, $entry_list )
    {
        __output_tournament_24_25_for_HTML( $series_info, $tournament_data, $entry_list, 'm' );
    }

    function output_tournament_25_for_HTML( $series_info, $tournament_data, $entry_list )
    {
        __output_tournament_24_25_for_HTML( $series_info, $tournament_data, $entry_list, 'w' );
    }
    ...
    function __output_entry_data_list_all_1_excel24_25( $sheet, $series, $mv, $start_pos, $series_name, $kaisai_rev )
    {
        $c = new common();
    ...
    function output_entry_data_list_all_1_excel24( $sheet )
    {
        __output_entry_data_list_all_1_excel24_25( $sheet, 16, 'm', 4, '団体戦男子', 1 );
        __output_entry_data_list_all_1_excel16_25( $sheet, 17, 'w', 4+48, '団体戦女子', 1 );
        return false;
    }

    function output_entry_data_list_all_1_excel25( $sheet )
    {
        __output_entry_data_list_all_1_excel24_25( $sheet, 16, 'm', 4, '団体戦男子', 1 );
        __output_entry_data_list_all_1_excel24_25( $sheet, 17, 'w', 4+48, '団体戦女子', 1 );
        return false;
    }

    //--------------------------------------------------------------

    function __get_entry_data_list2_24_25( $series )
    {
        $dbs = db_connect( DATABASE_HOST, DATABASE_USER, DATABASE_PASSWORD, DATABASE_NAME );
        $sql = 'select * from `entry_info`'
            .' where `series`='.$series.' and `year`='.$_SESSION['auth']['year']
    ...
    function get_entry_data_list2_24()
    {
        return __get_entry_data_list2_24_25( 24 );
    }

    function get_entry_data_list2_25()
    {
        return __get_entry_data_list2_24_25( 25 );
    }

    //--------------------------------------------------------------

    function __get_entry_data_for_draw_csv_24_25( $list, $series )
    {
        $c = new common();
    ...
    function get_entry_data_for_draw_csv_24( $list )
    {
        return array(
            'csv' => __get_entry_data_for_draw_csv_24_25( $list, 16 ),
            'file' => 'dantai_m.csv'
        );
    }

    function get_entry_data_for_draw_csv_25( $list )
    {
        return array(
            'csv' => __get_entry_data_for_draw_csv_24_25( $list, 17 ),
            'file' => 'dantai_w.csv'
        );
    }
    ...
    function __output_realtime_html_for_one_board_24_25( $place, $place_match_no )
    {
        global $navi_info;
...
*/
    ...
    function output_realtime_html_for_one_board_24( $place, $place_match_no )
    {
        //return __output_realtime_html_for_one_board_24_25( $place, $place_match_no );
        return '';
    }

    function output_realtime_html_for_one_board_25( $place, $place_match_no )
    {
        //return __output_realtime_html_for_one_board_24_25( $place, $place_match_no );
        return '';
    }
