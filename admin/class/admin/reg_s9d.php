<?php
	...
	function __get_league_parameter_36_37( $series_mw )
	{
		$param = array(
			'mw' => $series_mw,
			'team_num' => 3,
	...
	function get_league_parameter_36()
	{
        return __get_league_parameter_36_37( 'm' );
	}

	function get_league_parameter_37()
	{
        return __get_league_parameter_36_37( 'w' );
	}

	function __get_tournament_parameter_36_37()
	{
		$param = array(
			'mw' => $series_mw,
			'team_num' => 8,
	...
	function get_tournament_parameter_36()
	{
		__get_tournament_parameter_36_37( 'm' );
	}

	function get_tournament_parameter_37()
	{
		__get_tournament_parameter_36_37( 'w' );
	}

	function __get_entry_data_36_37_list_for_PDF( $series, $series_mw, $kaisai_rev )
	{
		$c = new common();
...
*/
	...
	function get_entry_data_36_list_for_PDF()
	{
		return __get_entry_data_36_37_list_for_PDF( 16, 'm', 1 );
	}

	function get_entry_data_37_list_for_PDF()
	{
		return __get_entry_data_36_37_list_for_PDF( 17, 'w', 1 );
	}


	function get_entry_data_list_36_sql( $mw )
	{
	...
	function output_league_36_for_HTML_2( $league_list, $entry_list, $mv )
	{
//print_r($league_list);
		if( $mv == 'm' ){
			$mvstr = '男子';
...
//							$html .= $league_list[$league_data]['match'][$match_no_index-1]['hon2'].'-'.$league_list[$league_data]['match'][$match_no_index-1]['win2'];
	...
	function __output_league_36_37_for_HTML( $navi_info, $league_param, $league_list, $entry_list, $mw )
	{
//echo $path;
//print_r($league_list);
		if( $mw == 'm' ){
...
//							$html .= $league_list[$league_data]['match'][$match_no_index-1]['hon2'].'-'.$league_list[$league_data]['match'][$match_no_index-1]['win2'];
	...
	function output_league_36_for_HTML( $navi_info, $league_param, $league_list, $entry_list )
	{
        $objPage = new form_page();
//print_r($league_list);
        $objPage->output_league_for_HTML( $navi_info, $league_param, $league_list, $entry_list, 'm', false );
		//__output_league_36_37_for_HTML( $path, get_league_parameter_36(), $league_list, $entry_list, 'm' );
	}
	...
	function output_league_37_for_HTML( $navi_info, $league_param, $league_list, $entry_list )
	{
		...
		//__output_league_36_37_for_HTML( $path, get_league_parameter_37(), $league_list, $entry_list, 'w' );
	}
	...
	function __output_league_36_37_for_Excel_one( $objPage, $sheet, $col, $row, $league_param, $league_list, $entry_list, $mv )
	{
//print_r($league_list);
		if( $mv == 'm' ){
			$mvstr = '男子';
	...
	function __output_league_36_37_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list, $mw )
	{
//print_r($league_list);
		if( $mw == 'm' ){
			$mwstr = '男子';
...
//echo "1:",$mg_range1,':',$mg_range2,'<br />';
	...
	function output_league_36_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list )
	{
		return __output_league_36_37_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list, 'm' );
	}

	function output_league_37_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list )
	{
		return __output_league_36_37_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list, 'w' );
	}

	//---------------------------------------------------------------
	//
	//---------------------------------------------------------------
	function __output_league_match_for_HTML2_36_37( $objPage, $path, $league_list, $entry_list, $mv )
	{
		if( $mv == 'm' ){
			$mvstr = '男子';
		} else {
	...
	function output_league_match_for_HTML2_36( $navi_info, $league_param, $league_list, $entry_list )
	{
		//__output_league_match_for_HTML2_36_37( $objPage, $path, $league_list, $entry_list, 'm' );
        $objPage = new form_page();
	...
	{
		//__output_league_match_for_HTML2_36_37( $objPage, $path, $league_list, $entry_list, 'w' );
        $objPage = new form_page();
	...
	function __output_league_match_for_excel_36_37( $objPage, $series_info, $league_param, $league_list, $entry_list, $mw )
	{
		if( $mw == 'm' ){
			$mwstr = '男子';
		} else {
...
//exit;
	...
	function output_league_match_for_excel_36( $objPage, $series_info, $league_param, $league_list, $entry_list )
	{
		return __output_league_match_for_excel_36_37( $objPage, $series_info, $league_param, $league_list, $entry_list, 'm' );
	}

	function output_league_match_for_excel_37( $objPage, $series_info, $league_param, $league_list, $entry_list )
	{
		return __output_league_match_for_excel_36_37( $objPage, $series_info, $league_param, $league_list, $entry_list, 'w' );
	}
	...
	function __output_tournament_match_36_37_for_excel( $objPage, $series_info, $tournament_param, $tournament_list, $league_data, $entry_list, $mw )
	{
		if( $mw == 'm' ){
			$mwstr = '男子';
		} else {
...
//        $objPage->output_one_match_for_excel( $sheet, $col, $row, $series_info, $tournament_data['match'][7], $entry_list, $mv, 46, 46 );
	...
	function output_tournament_match_36_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list )
	{
		return __output_tournament_match_36_37_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list, 'm' );
	}
	...
	{
		return __output_tournament_match_36_37_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list, 'w' );
	}
	...
	function __output_tournament_36_37_for_excel( $objPage, $series_info, $tournament_param, $tournament_list, $league_data, $entry_list, $mw )
	{
		if( $mw == 'm' ){
			$mwstr = '男子';
		} else {
...
//exit;
	...
	function __output_tournament_36_37_for_excel2( $objPage, $series_info, $tournament_param, $tournament_list, $league_data, $entry_list, $mw, $series_m, $series_w )
	{
		if( $mw == 'm' ){
			$mwstr = '男子';
		} else {
...
//exit;
	...
	function output_tournament_36_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list )
	{
		return __output_tournament_36_37_for_excel2( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list, 'm', 36, 37 );
	}

	function output_tournament_37_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list )
	{
		return __output_tournament_36_37_for_excel2( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list, 'w', 36, 37 );
	}
	...
	function __output_tournament_chart_36_37_for_excel( $objPage, $series_info, $tournament_list, $league_data, $entry_list, $mw )
	{
		if( $mw == 'm' ){
			$mwstr = '男子';
		} else {
	...
	function output_tournament_chart_36_for_excel( $objPage, $series_info, $tournament_data, $league_data, $entry_list )
	{
		return __output_tournament_chart_36_37_for_excel( $objPage, $series_info, $tournament_data, $league_data, $entry_list, 'm' );
	}

	function output_tournament_chart_37_for_excel( $objPage, $series_info, $tournament_data, $league_data, $entry_list )
	{
		return __output_tournament_chart_36_37_for_excel( $objPage, $series_info, $tournament_data, $league_data, $entry_list, 'w' );
	}
	...
	function __output_tournament_match_for_HTML2_36_37( $series_info, $tournament_list, $entry_list, $mw )
	{
		if( $mw == 'm' ){
			$mwstr = '男子';
		} else {
	...
	function output_tournament_match_for_HTML2_36( $series_info, $tournament_list, $entry_list )
	{
		__output_tournament_match_for_HTML2_36_37( $series_info, $tournament_list, $entry_list, 'm' );
	}

	function output_tournament_match_for_HTML2_37( $series_info, $tournament_list, $entry_list )
	{
		__output_tournament_match_for_HTML2_36_37( $series_info, $tournament_list, $entry_list, 'w' );
	}
	...
	function output_tournament_36_for_PDF( $tournament_data, $entry_list, $mv )
	{
//print_r($tournament_data);
		if( $mv == 'm' ){
			$mvstr = '男子';
...
exit;
	...
	function __output_tournament_36_37_for_HTML( $series_info, $tournament_list, $entry_list, $mv )
	{
//print_r($tournament_data);
//print_r($entry_list);
		if( $mv == 'm' ){
...
//exit;
	...
	function output_tournament_36_for_HTML( $series_info, $tournament_data, $entry_list )
	{
		__output_tournament_36_37_for_HTML( $series_info, $tournament_data, $entry_list, 'm' );
	}

	function output_tournament_37_for_HTML( $series_info, $tournament_data, $entry_list )
	{
		__output_tournament_36_37_for_HTML( $series_info, $tournament_data, $entry_list, 'w' );
	}
	...
	function __output_entry_data_list_all_1_excel36( $sheet, $series, $mv, $start_pos, $series_name, $kaisai_rev )
	{
		$c = new common();
	...
	function output_entry_data_list_all_1_excel36( $sheet )
	{
		$pos = __output_entry_data_list_all_1_excel36( $sheet, 36, 'm', 4, '小学生の部', 1 );
		$pos = __output_entry_data_list_all_1_excel36( $sheet, 37, 'm', $pos+1, '中学生男子の部', 1 );
		$pos = __output_entry_data_list_all_1_excel36( $sheet, 38, 'w', $pos+1, '中学生女子の部', 1 );
		$pos = __output_entry_data_list_all_1_excel36( $sheet, 39, 'm', $pos+1, '成年男子の部', 1 );
		$pos = __output_entry_data_list_all_1_excel36( $sheet, 40, 'w', $pos+1, '成年女子の部', 1 );
		return false;
	}

	//--------------------------------------------------------------

	function __get_entry_data_list2_36_37( $series )
	{
		$dbs = db_connect( DATABASE_HOST, DATABASE_USER, DATABASE_PASSWORD, DATABASE_NAME );
		$sql = 'select * from `entry_info`'
			.' where `series`='.$series .' and `year`='.$_SESSION['auth']['year']
	...
	function get_entry_data_list2_36()
	{
		return __get_entry_data_list2_36_37( 36 );
	}

	function get_entry_data_list2_37()
	{
		return __get_entry_data_list2_36_37( 37 );
	}

	//--------------------------------------------------------------

	function __get_entry_data_for_draw_csv_36_37( $list, $series )
	{
		$c = new common();
	...
	function get_entry_data_for_draw_csv_36( $list )
	{
		return array(
			'csv' => __get_entry_data_for_draw_csv_36_37( $list, 16 ),
			'file' => 'dantai_m.csv'
		);
	}
	...
	{
		return array(
			'csv' => __get_entry_data_for_draw_csv_36_37( $list, 17 ),
			'file' => 'dantai_w.csv'
		);
	}
	...
	function __output_realtime_html_for_one_board_36_37( $place, $place_match_no )
	{
		global $navi_info;
...
*/
	...
	function output_realtime_html_for_one_board_36( $place, $place_match_no )
	{
		//return __output_realtime_html_for_one_board_36_37( $place, $place_match_no );
		return '';
	}
	...
	//
	//---------------------------------------------------------------
	function draw_entry_data_list_36( $series_info )
	{
        require_once dirname(dirname(dirname(__FILE__))).'/phpExcel/Classes/PHPExcel.php';
        require_once dirname(dirname(dirname(__FILE__))).'/phpExcel/Classes/PHPExcel/IOFactory.php';
