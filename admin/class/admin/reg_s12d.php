<?php
	...
	function __get_league_parameter_16_17( $series_mw )
	{
		$param = array(
			'mw' => $series_mw,
			'team_num' => 3,
	...
	function get_league_parameter_16()
	{
        return array(
			'mw' => 'm',
			'team_num' => 3,
	...
	function get_league_parameter_17()
	{
        return __get_league_parameter_16_17( 'w' );
	}

	function __get_tournament_parameter_16_17()
	{
		$param = array(
			'mw' => 'w',
			'team_num' => 16,
	...
	function get_tournament_parameter_16()
	{
		__get_tournament_parameter_16_17();
	}

	function get_tournament_parameter_17()
	{
		__get_tournament_parameter_16_17();
	}

	function __get_entry_data_16_17_list_for_PDF( $series, $series_mw, $kaisai_rev )
	{
		$c = new common();
...
*/
	...
	function get_entry_data_16_list_for_PDF()
	{
		return __get_entry_data_16_17_list_for_PDF( 16, 'm', 1 );
	}

	function get_entry_data_17_list_for_PDF()
	{
		return __get_entry_data_16_17_list_for_PDF( 17, 'w', 1 );
	}


	function get_entry_data_list_16_sql( $mw )
	{
	...
	function output_league_16_for_HTML_2( $league_list, $entry_list, $mv )
	{
//print_r($league_list);
		if( $mv == 'm' ){
			$mvstr = '男子';
...
//							$html .= $league_list[$league_data]['match'][$match_no_index-1]['hon2'].'-'.$league_list[$league_data]['match'][$match_no_index-1]['win2'];
	...
	function __output_league_16_17_for_HTML( $navi_info, $league_param, $league_list, $entry_list, $mw )
	{
//echo $path;
//print_r($league_list);
		if( $mw == 'm' ){
...
//							$html .= $league_list[$league_data]['match'][$match_no_index-1]['hon2'].'-'.$league_list[$league_data]['match'][$match_no_index-1]['win2'];
	...
	function output_league_16_for_HTML( $navi_info, $league_param, $league_list, $entry_list )
	{
		//__output_league_16_17_for_HTML( $navi_info, $league_param, $league_list, $entry_list, 'm' );
        $objPage = new form_page();
        $objPage->output_league_for_HTML( $navi_info, $league_param, $league_list, $entry_list, 'm', false );
	}

	function output_league_17_for_HTML( $navi_info, $league_param, $league_list, $entry_list )
	{
		//__output_league_16_17_for_HTML( $navi_info, $league_param, $league_list, $entry_list, 'w' );
        $objPage = new form_page();
	...
	function __output_league_16_17_for_Excel_one( $objPage, $sheet, $col, $row, $league_param, $league_list, $entry_list, $mv )
	{
//print_r($league_list);
		if( $mv == 'm' ){
			$mvstr = '男子';
	...
	function __output_league_16_17_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list, $mw )
	{
//print_r($league_list);
		if( $mw == 'm' ){
			$mwstr = '男子';
		...
		$file_name = 'H30nanshinnLeagueResults_' . $mw . '.xls';
...
//echo "1:",$mg_range1,':',$mg_range2,'<br />';
	...
	function output_league_16_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list )
	{
		return __output_league_16_17_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list, 'm' );
	}

	function output_league_17_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list )
	{
		return __output_league_16_17_for_Excel( $objPage, $series_info, $league_param, $league_list, $entry_list, 'w' );
	}

	//---------------------------------------------------------------
	//
	//---------------------------------------------------------------
	function __output_league_match_for_HTML2_16_17( $objPage, $navi_info, $league_list, $entry_list, $mw )
	{
print_r($league_list);
print_r($entry_list);
		if( $mw == 'm' ){
	...
	function output_league_match_for_HTML2_16( $series_info, $league_param, $league_list, $entry_list )
	{
        $objPage = new form_page();
		//__output_league_match_for_HTML2_16_17( $objPage, $series_info, $league_list, $entry_list, 'm' );
        $objPage->output_league_match_for_HTML2( $series_info, $league_param, $league_list, $entry_list, 'm' );
	}

	function output_league_match_for_HTML2_17( $series_info, $league_param, $league_list, $entry_list )
	{
        $objPage = new form_page();
		//__output_league_match_for_HTML2_16_17( $objPage, $series_info, $league_list, $entry_list, 'w' );
        $objPage->output_league_match_for_HTML2( $series_info, $league_param, $league_list, $entry_list, 'w' );
	}
	...
	function __output_league_match_for_excel_16_17( $objPage, $series_info, $league_param, $league_list, $entry_list, $mw )
	{
		if( $mw == 'm' ){
			$mwstr = '男子';
		} else {
...
//print_r($league_list);
//exit;
		$file_name = 'H30nanshinnLeagueMatchResults_'.$mw.'.xls';
		$file_path = $series_info['output_path'] . '/' . $file_name;
	...
	function output_league_match_for_excel_16( $objPage, $series_info, $league_param, $league_list, $entry_list )
	{
		return __output_league_match_for_excel_16_17( $objPage, $series_info, $league_param, $league_list, $entry_list, 'm' );
	}

	function output_league_match_for_excel_17( $objPage, $series_info, $league_param, $league_list, $entry_list )
	{
		return __output_league_match_for_excel_16_17( $objPage, $series_info, $league_param, $league_list, $entry_list, 'w' );
	}
	...
	function __output_tournament_match_16_17_for_excel( $objPage, $series_info, $tournament_param, $tournament_list, $league_data, $entry_list, $mw )
	{
		if( $mw == 'm' ){
			$mwstr = '男子';
		} else {
		...
		require_once dirname(dirname(dirname(__FILE__))).'/phpExcel/Classes/PHPExcel.php';
		require_once dirname(dirname(dirname(__FILE__))).'/phpExcel/Classes/PHPExcel/IOFactory.php';
		$file_name = 'H30nanshinnTournamentMatchResults_' . $mw . '.xls';
		$file_path = $series_info['output_path'] . '/' . $file_name;
		...
		for( $match = 1; $match <= 8; $match++ ){
            if( $match <= 4 ){
                if( $mv == 'm' ){
                    ...
                    $sheet->setCellValueByColumnAndRow( 0, $row, '準々決勝 第'.($match-1).'試合' );
                }
            } else if( $match <= 6 ){
        ...
        if( $mv == 'm' ){
    		...
    		for( $i1 = 1; $i1 <= 2; $i1++ ){
                $objPage->output_one_match_for_excel( $sheet, $col, $row, $series_info, $tournament_data['match'][$i1+3], $entry_list, $mv, 46, 46 );
                $row += 6;
            }
        }
		for( $i1 = 1; $i1 <= 2; $i1++ ){
	...
	function output_tournament_match_16_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list )
	{
		return __output_tournament_match_16_17_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list, 'm' );
	}

	function output_tournament_match_17_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list )
	{
		return __output_tournament_match_16_17_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list, 'w' );
	}
	...
	function __output_tournament_16_17_for_excel( $objPage, $series_info, $tournament_param, $tournament_list, $league_data, $entry_list, $mw )
	{
		if( $mw == 'm' ){
			$mwstr = '男子';
		} else {
...
//exit;
	...
	function output_tournament_16_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list )
	{
		return __output_tournament_16_17_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list, 'm' );
	}

	function output_tournament_17_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list )
	{
		return __output_tournament_16_17_for_excel( $objPage, $series_info, $tournament_param, $tournament_data, $league_data, $entry_list, 'w' );
	}

	//---------------------------------------------------------------
	//
	//---------------------------------------------------------------
    function __output_tournament_chart_16_17_for_excel( $objPage, $series_info, $tournament_param, $tournament_list, $league_data, $entry_list, $mw )
    {
		if( $mw == 'm' ){
			$mwstr = '男子';
		} else {
...
//print_r($tournament_data);
//exit;
        $file_name = 'H30nanshinnDantaiTounamentResults_' . $mw . '.xls';
        $file_path = $series_info['output_path'] . '/' . $file_name;
        $excel = new PHPExcel();
        $excel->setActiveSheetIndex( 0 );        //何番目のシートに有効にするか
        $sheet = $excel->getActiveSheet();    //有効になっているシートを取得
...
//exit;
	...
	function __output_tournament_chart_16_17_for_excel2( $objPage, $path, $tournament_data, $league_data, $entry_list, $mv )
	{
		if( $mv == 'm' ){
			$mvstr = '男子';
		} else {
    ...
    function output_tournament_chart_16_for_excel( $objPage, $series_info, $tournament_param, $tournament_list, $league_data, $entry_list, $mw )
    {
        return __output_tournament_chart_16_17_for_excel( $objPage, $series_info, $tournament_param, $tournament_list, $league_data, $entry_list, 'm' );
    }

    function output_tournament_chart_17_for_excel( $objPage, $series_info, $tournament_param, $tournament_list, $league_data, $entry_list, $mw )
    {
        return __output_tournament_chart_16_17_for_excel( $objPage, $series_info, $tournament_param, $tournament_list, $league_data, $entry_list, 'w' );
    }
	...
	function __output_tournament_match_for_HTML2_16_17( $series_info, $tournament_list, $entry_list, $mw )
	{
		$objPage = new form_page();
		if( $mw == 'm' ){
			$mwstr = '男子';
        ...
        if( $mw == 'm' ){
            ...
            for( $i1 = 1; $i1 <= 2; $i1++ ){
                $html .= '<h3>団体決勝トーナメント&nbsp;準々決勝&nbsp;第'.$i1.'試合</h3>';
                $html .= $objPage->output_one_match_for_HTML2( $series_info, $tournament_list[0]['match'][$i1+3], $entry_list, $mw );
            }
        }
		for( $i1 = 1; $i1 <= 2; $i1++ ){
	...
	function output_tournament_match_for_HTML2_16( $series_info, $tournament_list, $entry_list )
	{
		__output_tournament_match_for_HTML2_16_17( $series_info, $tournament_list, $entry_list, 'm' );
	}

	function output_tournament_match_for_HTML2_17( $series_info, $tournament_list, $entry_list )
	{
		__output_tournament_match_for_HTML2_16_17( $series_info, $tournament_list, $entry_list, 'w' );
	}
	...
	function output_tournament_17_for_PDF( $tournament_data, $entry_list, $mv )
	{
	}

	function output_tournament_16_for_PDF( $tournament_data, $entry_list, $mv )
	{
//print_r($tournament_data);
		if( $mv == 'm' ){
			$mvstr = '男子';
...
exit;
	...
	function __output_tournament_16_17_for_HTML( $series_info, $tournament_list, $entry_list, $mw )
	{
//print_r($tournament_data);
//print_r($entry_list);
		if( $mw == 'm' ){
...
//echo $pdf;
//exit;
        $file = $series_info['result_path'] . '/dt_' . $series_info['result_prefix'] . $mw . $tindex.'.html';
		$fp = fopen( $file, 'w' );
		fwrite( $fp, $pdf );
		fclose( $fp );
	...
	function output_tournament_16_for_HTML( $series_info, $tournament_data, $entry_list )
	{
		__output_tournament_16_17_for_HTML( $series_info, $tournament_data, $entry_list, 'm' );
	}

	function output_tournament_17_for_HTML( $series_info, $tournament_data, $entry_list )
	{
		__output_tournament_16_17_for_HTML( $series_info, $tournament_data, $entry_list, 'w' );
	}
	...
	function __output_entry_data_list_all_1_excel16_17( $sheet, $series, $mv, $start_pos, $series_name, $kaisai_rev )
	{
		$c = new common();
	...
	function output_entry_data_list_all_1_excel16( $sheet )
	{
		__output_entry_data_list_all_1_excel16_17( $sheet, 16, 'm', 4, '団体戦男子', 1 );
		__output_entry_data_list_all_1_excel16_17( $sheet, 17, 'w', 4+48, '団体戦女子', 1 );
		return false;
	}

	function output_entry_data_list_all_1_excel17( $sheet )
	{
		__output_entry_data_list_all_1_excel16_17( $sheet, 16, 'm', 4, '団体戦男子', 1 );
		__output_entry_data_list_all_1_excel16_17( $sheet, 17, 'w', 4+48, '団体戦女子', 1 );
		return false;
	...
	function __get_entry_data_list2_16_17( $series )
	{
		$dbs = db_connect( DATABASE_HOST, DATABASE_USER, DATABASE_PASSWORD, DATABASE_NAME );
		$sql = 'select * from `entry_info`'
			.' where `series`='.$series.' and `year`='.$_SESSION['auth']['year']
	...
	function get_entry_data_list2_16()
	{
		return __get_entry_data_list2_16_17( 16 );
	}

	function get_entry_data_list2_17()
	{
		return __get_entry_data_list2_16_17( 17 );
	}

	//--------------------------------------------------------------

	function __get_entry_data_for_draw_csv_16_17( $list, $series )
	{
		$c = new common();
	...
	function get_entry_data_for_draw_csv_16( $list )
	{
		return array(
			'csv' => __get_entry_data_for_draw_csv_16_17( $list, 16 ),
			'file' => 'dantai_m.csv'
		);
	}

	function get_entry_data_for_draw_csv_17( $list )
	{
		return array(
			'csv' => __get_entry_data_for_draw_csv_16_17( $list, 17 ),
			'file' => 'dantai_w.csv'
		);
	}
	...
	function __output_realtime_html_for_one_board_16_17( $place, $place_match_no )
	{
		global $navi_info;
...
*/
	...
	function output_realtime_html_for_one_board_16( $place, $place_match_no )
	{
		//return __output_realtime_html_for_one_board_16_17( $place, $place_match_no );
		return '';
	}

	function output_realtime_html_for_one_board_17( $place, $place_match_no )
	{
		//return __output_realtime_html_for_one_board_16_17( $place, $place_match_no );
		return '';
	}
