<?php
	...
	function init_entry_post_data_from_def_4_shumoku_dantai_m( &$data, $def, $add1, $add2 )
	{
	...
	function get_entry_post_data_from_def_4_shumoku_dantai_m( $def, $add1, $add2 )
	{
	...
	function get_entry_db_data_from_def_4_shumoku_dantai_m( $data, $list, $def, $add1, $add2 )
	{
	...
	function update_entry_data_4_shumoku_dantai_m( $def, $dbs )
	{
		$data = array(
	...
	function init_entry_post_data_from_def_4_shumoku_dantai_w( &$data, $def, $add1, $add2 )
	{
	...
	function get_entry_post_data_from_def_4_shumoku_dantai_w( $def, $add1, $add2 )
	{
	...
	function get_entry_db_data_from_def_4_shumoku_dantai_w( $data, $list, $def, $add1, $add2 )
	{
	...
	function update_entry_data_4_shumoku_dantai_w( $def, $dbs )
	{
		$data = array(
