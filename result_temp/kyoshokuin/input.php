...
//    require_once dirname(dirname(dirname(__FILE__))).'/admin/class/admin/reg_s7d.php';
//    require_once dirname(dirname(dirname(__FILE__))).'/admin/class/admin/reg_s7k.php';
    require_once dirname(dirname(dirname(__FILE__))).'/admin/class/page.php';
    define( '__NAVI_ID__', 13 );
