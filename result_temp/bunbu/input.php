<?php
	...
	require_once dirname(dirname(dirname(__FILE__))).'/admin/class/admin/reg_2b.php';
	require_once dirname(dirname(dirname(__FILE__))).'/admin/class/admin/reg_3.php';
	require_once dirname(dirname(dirname(__FILE__))).'/admin/class/admin/reg_4.php';
	require_once dirname(dirname(dirname(__FILE__))).'/admin/class/admin/reg_5.php';
	require_once dirname(dirname(dirname(__FILE__))).'/admin/class/admin/reg_6.php';
	...
	if( $mode == 'login' ){
        ...
        $place = $objPage->login_navi( 1, $pass );
        if( $place >= 1 ){
            $navi = $objPage->get_series_place_navi_data( 1, $place, 1 );
			$_SESSION['auth_input']['login'] = 1;
		//$_SESSION['auth_input']['series'] = $pv['series'];
			$_SESSION['auth_input']['navi_id'] = 1;
